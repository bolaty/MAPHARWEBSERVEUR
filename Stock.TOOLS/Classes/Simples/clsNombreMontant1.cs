...
namespace Stock.TOOLS
{
    public class clsNombreMontant1
    {
       #region  declaration unique de la classe
        ...
        {
            //return Math.Round((vppMontant * Stock.TOOLS.clsDeclaration.vagParametresociete.Taxe) / 100);
            return 0;
        }
