...
namespace Stock.TOOLS
{
    public class clsFTP
    {
        ...
        private readonly static clsFTP ClassesFTP = new clsFTP();
        int vapCompteur = 0;
        ...
        public static clsFTP ClasseFTP
        {
            get { return ClassesFTP; }
        }
        #endregion
    ...
    /* Construct Object */
    public clsFTP(string hostIP, string userName, string password) 
