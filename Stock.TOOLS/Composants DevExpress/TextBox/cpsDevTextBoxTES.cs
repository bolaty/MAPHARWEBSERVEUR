...
{
/// <summary>
/// Cette classe represente un text box generique de saisie des Site web qui respect l'alignement gauche
...
/// </summary>
    ...
    public class cpsDevTextBoxTES : DevExpress.XtraEditors.TextEdit
    {
