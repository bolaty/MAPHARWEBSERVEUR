...
namespace Stock.WCF
{
        ...
        try
        {
            ...
            if (DataSet.Tables[0].Rows.Count > 0)
            {
                foreach (DataRow row in DataSet.Tables[0].Rows)
                {
                    ...
                    clsEditionEtatParametre.PL_REPORTDEBIT = Stock.WSTOOLS.clsNombreMontant.ClasseNombre.pvgFormatageEnMillier(Double.Parse(row["PL_REPORTDEBIT"].ToString()).ToString(),"M");
                    clsEditionEtatParametre.PL_REPORTCREDIT = Stock.WSTOOLS.clsNombreMontant.ClasseNombre.pvgFormatageEnMillier(Double.Parse(row["PL_REPORTCREDIT"].ToString()).ToString(), "M");
                    clsEditionEtatParametre.PL_MONTANTPERIODEPRECEDENTDEBIT = Stock.WSTOOLS.clsNombreMontant.ClasseNombre.pvgFormatageEnMillier(Double.Parse(row["PL_MONTANTPERIODEPRECEDENTDEBIT"].ToString()).ToString(), "M");
                    clsEditionEtatParametre.PL_MONTANTPERIODEPRECEDENTCREDIT = Stock.WSTOOLS.clsNombreMontant.ClasseNombre.pvgFormatageEnMillier(Double.Parse(row["PL_MONTANTPERIODEPRECEDENTCREDIT"].ToString()).ToString(), "M");
                    clsEditionEtatParametre.PL_MONTANTPERIODEDEBITENCOURS = Stock.WSTOOLS.clsNombreMontant.ClasseNombre.pvgFormatageEnMillier(Double.Parse(row["PL_MONTANTPERIODEDEBITENCOURS"].ToString()).ToString(), "M");
                    clsEditionEtatParametre.PL_MONTANTPERIODECREDITENCOURS = Stock.WSTOOLS.clsNombreMontant.ClasseNombre.pvgFormatageEnMillier(Double.Parse(row["PL_MONTANTPERIODECREDITENCOURS"].ToString()).ToString(), "M");
                    clsEditionEtatParametre.PL_MONTANTSOLDEFINALDEBIT = Stock.WSTOOLS.clsNombreMontant.ClasseNombre.pvgFormatageEnMillier(Double.Parse(row["PL_MONTANTSOLDEFINALDEBIT"].ToString()).ToString(), "M");
                    clsEditionEtatParametre.PL_MONTANTSOLDEFINALCREDIT = Stock.WSTOOLS.clsNombreMontant.ClasseNombre.pvgFormatageEnMillier(Double.Parse(row["PL_MONTANTSOLDEFINALCREDIT"].ToString()).ToString(), "M");
    ...
    foreach (DataRow row in DataSet.Tables[0].Rows)
    {
        ...
        clsEditionEtatParametre.PA_MONTANTMINI = row["PA_MONTANTMINI"].ToString();
        clsEditionEtatParametre.PA_MONTANTMAXI = row["PA_MONTANTMAXI"].ToString();
        clsEditionEtatParametre.PA_TAUX = row["PA_TAUX"].ToString();
        clsEditionEtatParametre.PA_MONTANT = row["PA_MONTANT"].ToString();
        ...
        clsEditionEtatParametre.PP_MONTANT = row["PP_MONTANT"].ToString();
        clsEditionEtatParametre.PP_MONTANTMAXI = row["PP_MONTANTMAXI"].ToString();
        clsEditionEtatParametre.PP_MONTANTMINI = row["PP_MONTANTMINI"].ToString();
