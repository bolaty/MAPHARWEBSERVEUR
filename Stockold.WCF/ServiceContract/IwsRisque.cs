...
namespace Stock.WCF
{
	...
	// REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom d'interface "IwsRisque" à la fois dans le code et le fichier de configuration.
	[ServiceContract]
	public interface IwsRisque
	{
        ...
        //// http://localhost:2723/Service/wsRisque.svc/pvgChargerDansDataSetPourCombo
        ...
        List<HT_Stock.BOJ.clsCtparrisqueassurance> pvgChargerDansDataSetPourCombo(List<HT_Stock.BOJ.clsCtparrisqueassurance> Objet);
