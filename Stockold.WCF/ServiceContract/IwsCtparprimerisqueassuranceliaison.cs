...
namespace Stock.WCF
{
	...
	// REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom d'interface "IwsCtparprimerisqueassuranceliaison" à la fois dans le code et le fichier de configuration.
	[ServiceContract]
	public interface IwsCtparprimerisqueassuranceliaison
	{
        ...
        List<HT_Stock.BOJ.clsCtparprimerisqueassuranceliaison> pvgChargerDansDataSet(List<HT_Stock.BOJ.clsCtparprimerisqueassuranceliaison> Objet);
