...
namespace Stock.WCF
{
	...
	// REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom d'interface "IwsCtpardesignation" à la fois dans le code et le fichier de configuration.
	[ServiceContract]
	public interface IwsCtpardesignation
	{
        ...
        List<HT_Stock.BOJ.clsCtpardesignation> pvgChargerDansDataSetPourCombo(List<HT_Stock.BOJ.clsCtpardesignation> Objet);
