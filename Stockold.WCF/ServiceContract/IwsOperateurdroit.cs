...
namespace Stock.WCF
{
	...
	// REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom d'interface "IwsOperateurdroit" à la fois dans le code et le fichier de configuration.
	[ServiceContract]
	public interface IwsOperateurdroit
	{
        ...
        //// http://localhost:2723/Service/wsOperateurdroit.svc/pvgAjouter
        ...
        List<HT_Stock.BOJ.clsOperateurdroit> pvgAjouter(List<HT_Stock.BOJ.clsOperateurdroit> Objet);
        ...
        List<HT_Stock.BOJ.clsOperateurdroit> pvgAjouterdroit(List<HT_Stock.BOJ.clsOperateurdroit> Objet);       
        ...
        ///<author>Home Technology</author>
        ///  PARAMETRES DE TEST POSTMAN
        //// http://localhost:2723/Service/wsOperateurdroit.svc/pvgModifier
        ///  {"Objet" :[{"CodeAgence": "","CodeOperateur": "","CodeOperateurdroit": "","Libelle": "", "TYPEOPERATION": ""}]}
        [OperationContract]
        //[WebInvoke(Method = "GET", ResponseFormat = WebMessageFormat.Json, BodyStyle = WebMessageBodyStyle.Wrapped, UriTemplate = "pvgSelectListe/{PO_CODEOperateurdroit}/{TYPEOPERATION}")]
        ...
        List<HT_Stock.BOJ.clsOperateurdroit> pvgModifier(List<HT_Stock.BOJ.clsOperateurdroit> Objet);
        ...
        ///<author>Home Technology</author>
        ///  PARAMETRES DE TEST POSTMAN
        //// http://localhost:2723/Service/wsOperateurdroit.svc/pvgSupprimer
        ///  {"Objet" :[{"CodeAgence": "","CodeOperateur": "","CodeOperateurdroit": "","Libelle": "", "TYPEOPERATION": ""}]}
        [OperationContract]
        //[WebInvoke(Method = "GET", ResponseFormat = WebMessageFormat.Json, BodyStyle = WebMessageBodyStyle.Wrapped, UriTemplate = "pvgSelectListe/{PO_CODEOperateurdroit}/{TYPEOPERATION}")]
        ...
        List<HT_Stock.BOJ.clsOperateurdroit> pvgSupprimer(List<HT_Stock.BOJ.clsOperateurdroit> Objet);
        ...
        ///<author>Home Technology</author>
        ///  PARAMETRES DE TEST POSTMAN
        //// http://localhost:2723/Service/wsOperateurdroit.svc/pvgChargerDansDataSet
        ///  {"Objet" :[{"CodeAgence": "","CodeOperateur": "","CodeOperateurdroit": "","Libelle": "", "TYPEOPERATION": ""}]}
        [OperationContract]
        //[WebInvoke(Method = "GET", ResponseFormat = WebMessageFormat.Json, BodyStyle = WebMessageBodyStyle.Wrapped, UriTemplate = "pvgSelectListe/{PO_CODEOperateurdroit}/{TYPEOPERATION}")]
        ...
        List<HT_Stock.BOJ.clsOperateurdroit> pvgChargerDansDataSet(List<HT_Stock.BOJ.clsOperateurdroit> Objet);
        ...
        ///<author>Home Technology</author>
        ///  PARAMETRES DE TEST POSTMAN
        //// http://localhost:2723/Service/wsOperateurdroit.svc/pvgChargerDansDataSetPourCombo
        ///  {"Objet" :[{"CodeAgence": "","CodeOperateur": "","CodeOperateurdroit": "","Libelle": "", "TYPEOPERATION": ""}]}
        [OperationContract]
        //[WebInvoke(Method = "GET", ResponseFormat = WebMessageFormat.Json, BodyStyle = WebMessageBodyStyle.Wrapped, UriTemplate = "pvgSelectListe/{PO_CODEOperateurdroit}/{TYPEOPERATION}")]
        ...
        List<HT_Stock.BOJ.clsOperateurdroit> pvgChargerDansDataSetPourCombo(List<HT_Stock.BOJ.clsOperateurdroit> Objet);
