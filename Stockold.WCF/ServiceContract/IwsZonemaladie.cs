...
namespace Stock.WCF
{
	...
	// REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom d'interface "IwsZonemaladie" à la fois dans le code et le fichier de configuration.
	[ServiceContract]
	public interface IwsZonemaladie
	{
        ...
        //// http://localhost:2723/Service/wsZonemaladie.svc/pvgAjouter
        ...
        List<HT_Stock.BOJ.clsZonemaladie> pvgAjouter(List<HT_Stock.BOJ.clsZonemaladie> Objet);
        ...
        ///<author>Home Technology</author>
        ///  PARAMETRES DE TEST POSTMAN
        //// http://localhost:2723/Service/wsZonemaladie.svc/pvgModifier
        ///  {"Objet" :[{"CodeAgence": "","CodeOperateur": "","CodeActivite": "","Libelle": "", "TYPEOPERATION": ""}]}
        [OperationContract]
        //[WebInvoke(Method = "GET", ResponseFormat = WebMessageFormat.Json, BodyStyle = WebMessageBodyStyle.Wrapped, UriTemplate = "pvgSelectListe/{PO_CODEActivite}/{TYPEOPERATION}")]
        ...
        List<HT_Stock.BOJ.clsZonemaladie> pvgModifier(List<HT_Stock.BOJ.clsZonemaladie> Objet);
        ...
        ///<author>Home Technology</author>
        ///  PARAMETRES DE TEST POSTMAN
        //// http://localhost:2723/Service/wsZonemaladie.svc/pvgSupprimer
        ///  {"Objet" :[{"CodeAgence": "","CodeOperateur": "","CodeActivite": "","Libelle": "", "TYPEOPERATION": ""}]}
        [OperationContract]
        //[WebInvoke(Method = "GET", ResponseFormat = WebMessageFormat.Json, BodyStyle = WebMessageBodyStyle.Wrapped, UriTemplate = "pvgSelectListe/{PO_CODEActivite}/{TYPEOPERATION}")]
        ...
        List<HT_Stock.BOJ.clsZonemaladie> pvgSupprimer(List<HT_Stock.BOJ.clsZonemaladie> Objet);
        ...
        ///<author>Home Technology</author>
        ///  PARAMETRES DE TEST POSTMAN
        //// http://localhost:2723/Service/wsZonemaladie.svc/pvgChargerDansDataSet
        ///  {"Objet" :[{"CodeAgence": "","CodeOperateur": "","CodeActivite": "","Libelle": "", "TYPEOPERATION": ""}]}
        [OperationContract]
        //[WebInvoke(Method = "GET", ResponseFormat = WebMessageFormat.Json, BodyStyle = WebMessageBodyStyle.Wrapped, UriTemplate = "pvgSelectListe/{PO_CODEActivite}/{TYPEOPERATION}")]
        ...
        List<HT_Stock.BOJ.clsZonemaladie> pvgChargerDansDataSet(List<HT_Stock.BOJ.clsZonemaladie> Objet);
        ...
        ///<author>Home Technology</author>
        ///  PARAMETRES DE TEST POSTMAN
        //// http://localhost:2723/Service/wsZonemaladie.svc/pvgChargerDansDataSetPourCombo
        ///  {"Objet" :[{"CodeAgence": "","CodeOperateur": "","CodeActivite": "","Libelle": "", "TYPEOPERATION": ""}]}
        [OperationContract]
        //[WebInvoke(Method = "GET", ResponseFormat = WebMessageFormat.Json, BodyStyle = WebMessageBodyStyle.Wrapped, UriTemplate = "pvgSelectListe/{PO_CODEActivite}/{TYPEOPERATION}")]
        ...
        List<HT_Stock.BOJ.clsZonemaladie> pvgChargerDansDataSetPourCombo(List<HT_Stock.BOJ.clsZonemaladie> Objet);
