...
namespace Stock.WCF
{
	...
	// REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom d'interface "IwsVille" à la fois dans le code et le fichier de configuration.
	[ServiceContract]
	public interface IwsVille
	{
        ...
        List<HT_Stock.BOJ.clsVille> pvgChargerDansDataSetPourCombo(List<HT_Stock.BOJ.clsVille> Objet);
