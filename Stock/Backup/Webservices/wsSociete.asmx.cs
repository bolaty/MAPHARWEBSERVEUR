...
namespace Stock.WS
{
    ...
    [WebService(Namespace = "http://192.168.1.100:73/Webservices/wsSociete.asmx")]
    [WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1)]
    [System.ComponentModel.ToolboxItem(false)]
    // Pour autoriser l'appel de ce service Web depuis un script à l'aide d'ASP.NET AJAX, supprimez les marques de commentaire de la ligne suivante.  
    // [System.Web.Script.Services.ScriptService] 
    public class wsSociete : System.Web.Services.WebService, IAsmx<clsSociete>
    {
        ...
        public clsObjetRetour pvgValeurScalaireRequeteCount(clsObjetEnvoi clsObjetEnvoi)
        {
            ...
            try
            {
                ...
                clsObjetRetour.SetValue(true, clsSocieteWSBLL.pvgValeurScalaireRequeteCount(clsDonnee, clsObjetEnvoi));
            }
        ...
        public clsObjetRetour pvgValeurScalaireRequeteMin(clsObjetEnvoi clsObjetEnvoi)
        {
            ...
            try
            {
                ...
                clsDonnee.vogUtilisateur = clsObjetEnvoi.OE_X;
                clsDonnee.pvgConnectionBase();
                clsObjetRetour.SetValue(true, clsSocieteWSBLL.pvgValeurScalaireRequeteMin(clsDonnee, clsObjetEnvoi));
            }
            catch (SqlException SQLEx)
            {
                clsObjetRetour.SetValueMessage(false, SQLEx.Message);
        ...
        public clsObjetRetour pvgValeurScalaireRequeteMax(clsObjetEnvoi clsObjetEnvoi)
        {
            ...
            try
            {
                ...
                clsDonnee.vogUtilisateur = clsObjetEnvoi.OE_X;
                clsDonnee.pvgConnectionBase();
                clsObjetRetour.SetValue(true, clsSocieteWSBLL.pvgValeurScalaireRequeteMax(clsDonnee, clsObjetEnvoi));
            }
            catch (SqlException SQLEx)
            {
                clsObjetRetour.SetValueMessage(false, SQLEx.Message);
        ...
        public clsObjetRetour pvgTableLibelle(clsObjetEnvoi clsObjetEnvoi)
        {
            ...
            try
            {
                ...
                clsDonnee.vogUtilisateur = clsObjetEnvoi.OE_X;
                clsDonnee.pvgConnectionBase();
                clsObjetRetour.SetValue(true, clsSocieteWSBLL.pvgTableLibelle(clsDonnee, clsObjetEnvoi));
            }
            catch (SqlException SQLEx)
            {
                clsObjetRetour.SetValueMessage(false, SQLEx.Message);
        ...
        [WebMethod(MessageName = "pvgTableLibelleDATESYSTEMSERVEUR", Description = "pvgTableLibelleDATESYSTEMSERVEUR", EnableSession = true)]
        public clsObjetRetour pvgTableLibelleDATESYSTEMSERVEUR(clsObjetEnvoi clsObjetEnvoi)
        {
            clsObjetRetour clsObjetRetour = new clsObjetRetour();
            try
            {
                ...
                clsDonnee.vogUtilisateur = clsObjetEnvoi.OE_X;
                clsDonnee.pvgConnectionBase();
                clsObjetRetour.SetValue(true, clsSocieteWSBLL.pvgTableLibelleDATESYSTEMSERVEUR(clsDonnee, clsObjetEnvoi));
            }
            catch (SqlException SQLEx)
            {
                clsObjetRetour.SetValueMessage(false, SQLEx.Message);
        ...
        public clsObjetRetour pvgAjouter(clsSociete clsSociete, clsObjetEnvoi clsObjetEnvoi)
        {
            clsObjetRetour clsObjetRetour = new clsObjetRetour();
            try
            {
                ...
                clsObjetRetour.SetValue(true, clsSocieteWSBLL.pvgAjouter(clsDonnee, clsSociete, clsObjetEnvoi), clsMessagesWSBLL.pvgTableLibelle(clsDonnee, "GNE0069").MS_LIBELLEMESSAGE);
            }
            catch (SqlException SQLEx)
            {
        ...
        public clsObjetRetour pvgAjouterListe(List<clsSociete> clsSocietes, clsObjetEnvoi clsObjetEnvoi)
        {
            clsObjetRetour clsObjetRetour = new clsObjetRetour();
            try
            {
                ...
                clsDonnee.vogUtilisateur = clsObjetEnvoi.OE_X;
                clsDonnee.pvgDemarrerTransaction();
                clsObjetRetour.SetValue(true, clsSocieteWSBLL.pvgAjouterListe(clsDonnee, clsSocietes, clsObjetEnvoi), clsMessagesWSBLL.pvgTableLibelle(clsDonnee, "GNE0069").MS_LIBELLEMESSAGE);
            }
            catch (SqlException SQLEx)
            {
                string vlpMessage = (SQLEx.Number == 2601 || SQLEx.Number == 2627) ? clsMessagesWSBLL.pvgTableLibelle(clsDonnee, "GNE0003").MS_LIBELLEMESSAGE : SQLEx.Message;
        ...
        public clsObjetRetour pvgModifier(clsSociete clsSociete, clsObjetEnvoi clsObjetEnvoi)
        {
            clsObjetRetour clsObjetRetour = new clsObjetRetour();
            try
            {
                ...
                clsDonnee.vogUtilisateur = clsObjetEnvoi.OE_X;
                clsDonnee.pvgDemarrerTransaction();
                clsObjetRetour.SetValue(true, clsSocieteWSBLL.pvgModifier(clsDonnee, clsSociete, clsObjetEnvoi), clsMessagesWSBLL.pvgTableLibelle(clsDonnee, "GNE0068").MS_LIBELLEMESSAGE);
            }
            catch (SqlException SQLEx)
            {
                string vlpMessage = (SQLEx.Number == 2601 || SQLEx.Number == 2627) ? clsMessagesWSBLL.pvgTableLibelle(clsDonnee, "GNE0003").MS_LIBELLEMESSAGE : SQLEx.Message;
        ...
        public clsObjetRetour pvgSupprimer(clsObjetEnvoi clsObjetEnvoi)
        {
            ...
            try
            {
                ...
                clsDonnee.vogUtilisateur = clsObjetEnvoi.OE_X;
                clsDonnee.pvgDemarrerTransaction();
                clsObjetRetour.SetValue(true, clsSocieteWSBLL.pvgSupprimer(clsDonnee, clsObjetEnvoi), clsMessagesWSBLL.pvgTableLibelle(clsDonnee, "VIT0002").MS_LIBELLEMESSAGE);
            }
            catch (SqlException SQLEx)
            {
        ...
        public clsObjetRetour pvgCharger(clsObjetEnvoi clsObjetEnvoi)
        {
            ...
            try
            {
                ...
                clsDonnee.vogUtilisateur = clsObjetEnvoi.OE_X;
                clsDonnee.pvgConnectionBase();
                clsObjetRetour.SetValue(true, clsSocieteWSBLL.pvgCharger(clsDonnee, clsObjetEnvoi));
            }
            catch (SqlException SQLEx)
            {
                clsObjetRetour.SetValueMessage(false, SQLEx.Message);
        ...
        public clsObjetRetour pvgChargerAPartirDataSet(clsObjetEnvoi clsObjetEnvoi)
        {
            ...
            try
            {
                ...
                clsDonnee.vogUtilisateur = clsObjetEnvoi.OE_X;
                clsDonnee.pvgConnectionBase();
                clsObjetRetour.SetValue(true, clsSocieteWSBLL.pvgChargerAPartirDataSet(clsDonnee, clsObjetEnvoi));
            }
            catch (SqlException SQLEx)
            {
                clsObjetRetour.SetValueMessage(false, SQLEx.Message);
        ...
        public clsObjetRetour pvgChargerDansDataSet(clsObjetEnvoi clsObjetEnvoi)
        {
            ...
            try
            {
                ...
                clsDonnee.vogUtilisateur = clsObjetEnvoi.OE_X;
                clsDonnee.pvgConnectionBase();
                clsObjetRetour.SetValue(true, clsSocieteWSBLL.pvgChargerDansDataSet(clsDonnee, clsObjetEnvoi));
            }
            catch (SqlException SQLEx)
            {
                clsObjetRetour.SetValueMessage(false, SQLEx.Message);
        ...
        public clsObjetRetour pvgChargerDansDataSet1(clsObjetEnvoi clsObjetEnvoi)
        {
            ...
            try
            {
                ...
                clsDonnee.vogUtilisateur = clsObjetEnvoi.OE_X;
                clsDonnee.pvgConnectionBase();
                clsObjetRetour.SetValue(true, clsSocieteWSBLL.pvgChargerDansDataSet1(clsDonnee, clsObjetEnvoi));
            }
            catch (SqlException SQLEx)
            {
                clsObjetRetour.SetValueMessage(false, SQLEx.Message);
        ...
        public clsObjetRetour pvgChargerDansDataSetPourCombo(clsObjetEnvoi clsObjetEnvoi)
        {
            ...
            try
            {
                ...
                clsDonnee.vogUtilisateur = clsObjetEnvoi.OE_X;
                clsDonnee.pvgConnectionBase();
                clsObjetRetour.SetValue(true, clsSocieteWSBLL.pvgChargerDansDataSetPourCombo(clsDonnee, clsObjetEnvoi));
            }
            catch (SqlException SQLEx)
            {
                clsObjetRetour.SetValueMessage(false, SQLEx.Message);
