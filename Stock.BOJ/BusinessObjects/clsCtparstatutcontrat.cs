...
namespace Stock.BOJ
{
	public class clsCtparstatutcontrat
	{
		...
		public clsCtparstatutcontrat( string CT_CODESTAUT,string CT_LIBELLESTATUT,int CT_NUMEROORDRE)
		{
