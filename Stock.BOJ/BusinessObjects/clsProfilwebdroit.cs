...
namespace Stock.BOJ
{
	public class clsProfilwebdroit
    {
        ...
        public clsProfilwebdroit(string PO_CODEPROFILWEB, int OB_CODEOBJET, string PD_AUTORISER, string PD_AJOUTER, string PD_MODIFIER, string PD_SUPPRIMER, string PD_APERCU, string PD_IMPRIMER, string PD_IMPRIMERTOUT, string LO_CODELOGICIEL, string OB_RATTACHEA, int PD_NUMEROORDRE)
		{
