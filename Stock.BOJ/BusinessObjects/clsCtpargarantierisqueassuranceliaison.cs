...
namespace Stock.BOJ
{
	public class clsCtpargarantierisqueassuranceliaison
	{
        ...
        private double _CG_FRANCHISES = 0;
        private double _CG_TAUX = 0;
