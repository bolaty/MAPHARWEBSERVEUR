...
namespace Stock.BOJ
{
	public class clsBienimmobilisefamille
	{
		...
		private int _PS_DUREEMINIMUM = 0;
		private int _PS_DUREEMAXIMUM = 0;
		private string _PS_AMORTISSEMENTDIRECT = "";
		private string _PS_AMORTISSEMENTBIEN = "";
		private int _PS_AMORTISSEMENTVALEURRESIDUELLEZERO = 0;
		private string _PS_ACTIF = "";
		private int _PS_NUMEROORDRE = 0;
		private DateTime _PS_DATESAISIE = DateTime.Parse("01/01/1900");
		...
		public int PS_AMORTISSEMENTVALEURRESIDUELLEZERO
		{
		...
		public int PS_NUMEROORDRE
		{
			get { return _PS_NUMEROORDRE; }
			set {  _PS_NUMEROORDRE = value; }
		}

		public DateTime PS_DATESAISIE
		{
