...
namespace Stock.BOJ
{
	public class clsLogiciel
	{
		...
		public clsLogiciel(){}
		public clsLogiciel( string LO_CODELOGICIEL,string LO_LIBELLE,double LO_NUMEROORDRE,string LO_STATUTLOGICIEL)
		{
