...
{
	public class clsCtsinistrechequephotoWSDAL: ITableDAL<clsCtsinistrechequephoto>
	{
		...
		public string pvgValueScalarRequeteCount(clsDonnee clsDonnee, params string[] vppCritere)
		{
			...
			this.vapRequete = "SELECT COUNT(AG_CODEAGENCE) AS AG_CODEAGENCE  FROM dbo.FT_CTSINISTRECHEQUEPHOTO(@CODECRYPTAGE) " + this.vapCritere;
			this.vapCritere = "";
		...
		{
			pvpChoixCritere(clsDonnee ,vppCritere);
			this.vapRequete = "SELECT MIN(AG_CODEAGENCE) AS AG_CODEAGENCE  FROM dbo.FT_CTSINISTRECHEQUEPHOTO(@CODECRYPTAGE) " + this.vapCritere;
			this.vapCritere = "";
			SqlCommand vppSqlCmd = new SqlCommand(this.vapRequete, clsDonnee.vogObjetConnexionLocal, clsDonnee.vogObjetTransactionLocal);
			return clsDonnee.pvgValueScalarRequete(vppSqlCmd, vapNomParametre, vapValeurParametre);
		}
		...
		{
			pvpChoixCritere(clsDonnee ,vppCritere);
			this.vapRequete = "SELECT MAX(AG_CODEAGENCE) AS AG_CODEAGENCE  FROM dbo.FT_CTSINISTRECHEQUEPHOTO(@CODECRYPTAGE) " + this.vapCritere;
			this.vapCritere = "";
			SqlCommand vppSqlCmd = new SqlCommand(this.vapRequete, clsDonnee.vogObjetConnexionLocal, clsDonnee.vogObjetTransactionLocal);
			return clsDonnee.pvgValueScalarRequete(vppSqlCmd, vapNomParametre, vapValeurParametre);
		}
		...
		///<author>Home Technology</author>
		public clsCtsinistrechequephoto pvgTableLabel(clsDonnee clsDonnee, params string[] vppCritere)
		{
			pvpChoixCritere(clsDonnee ,vppCritere);
			this.vapRequete = "SELECT CH_CHEMINPHOTOCHEQUE  , CH_LIBELLEPHOTOCHEQUE  FROM dbo.FT_CTSINISTRECHEQUEPHOTO(@CODECRYPTAGE) " + this.vapCritere;
			this.vapCritere = "";
			SqlCommand vppSqlCmd = new SqlCommand(this.vapRequete, clsDonnee.vogObjetConnexionLocal, clsDonnee.vogObjetTransactionLocal);
			clsCtsinistrechequephoto clsCtsinistrechequephoto = new clsCtsinistrechequephoto();
			if(clsDonnee.pvgRemplirDataReader(vppSqlCmd, vapNomParametre, vapValeurParametre))
			{
				while(clsDonnee.vogDataReader.Read())
				{
					clsCtsinistrechequephoto.CH_CHEMINPHOTOCHEQUE = clsDonnee.vogDataReader["CH_CHEMINPHOTOCHEQUE"].ToString();
					clsCtsinistrechequephoto.CH_LIBELLEPHOTOCHEQUE = clsDonnee.vogDataReader["CH_LIBELLEPHOTOCHEQUE"].ToString();
				}
				clsDonnee.vogDataReader.Dispose();
			}
		return clsCtsinistrechequephoto;
		}
		...
		///<author>Home Technology</author>
		public void pvgInsert(clsDonnee clsDonnee, clsCtsinistrechequephoto clsCtsinistrechequephoto)
		{
			//Préparation des paramètres
			SqlParameter vppParamAG_CODEAGENCE = new SqlParameter("@AG_CODEAGENCE1", SqlDbType.VarChar, 25);
			vppParamAG_CODEAGENCE.Value  = clsCtsinistrechequephoto.AG_CODEAGENCE ;
			SqlParameter vppParamCH_DATESAISIECHEQUE = new SqlParameter("@CH_DATESAISIECHEQUE1", SqlDbType.DateTime);
			vppParamCH_DATESAISIECHEQUE.Value  = clsCtsinistrechequephoto.CH_DATESAISIECHEQUE ;
			SqlParameter vppParamCH_IDEXCHEQUE = new SqlParameter("@CH_IDEXCHEQUE1", SqlDbType.VarChar, 25);
			vppParamCH_IDEXCHEQUE.Value  = clsCtsinistrechequephoto.CH_IDEXCHEQUE ;
			SqlParameter vppParamCH_NUMSEQUENCEPHOTO = new SqlParameter("@CH_NUMSEQUENCEPHOTO", SqlDbType.VarChar, 25);
			vppParamCH_NUMSEQUENCEPHOTO.Value  = clsCtsinistrechequephoto.CH_NUMSEQUENCEPHOTO ;
			SqlParameter vppParamCH_CHEMINPHOTOCHEQUE = new SqlParameter("@CH_CHEMINPHOTOCHEQUE", SqlDbType.VarChar, 1000);
			vppParamCH_CHEMINPHOTOCHEQUE.Value  = clsCtsinistrechequephoto.CH_CHEMINPHOTOCHEQUE ;
			SqlParameter vppParamCH_LIBELLEPHOTOCHEQUE = new SqlParameter("@CH_LIBELLEPHOTOCHEQUE", SqlDbType.VarChar, 1000);
			vppParamCH_LIBELLEPHOTOCHEQUE.Value  = clsCtsinistrechequephoto.CH_LIBELLEPHOTOCHEQUE ;
			SqlParameter vppParamCODECRYPTAGE = new SqlParameter("@CODECRYPTAGE1", SqlDbType.VarChar, 50);
			vppParamCODECRYPTAGE.Value = clsDonnee.vogCleCryptage;

			//Préparation de la commande
			 this.vapRequete = "EXECUTE PC_CTSINISTRECHEQUEPHOTO  @AG_CODEAGENCE1, @CH_DATESAISIECHEQUE1, @CH_IDEXCHEQUE1, @CH_NUMSEQUENCEPHOTO, @CH_CHEMINPHOTOCHEQUE, @CH_LIBELLEPHOTOCHEQUE, @CODECRYPTAGE1, 0 ";
			SqlCommand vppSqlCmd = new SqlCommand(this.vapRequete, clsDonnee.vogObjetConnexionLocal, clsDonnee.vogObjetTransactionLocal);
        ...
        ///<param name=clsCtsinistrechequephoto>clsCtsinistrechequephoto</param>
        ///<author>Home Technology</author>
        public string pvgMiseAJour(clsDonnee clsDonnee, clsCtsinistrechequephoto clsCtsinistrechequephoto)
        {
	        //Préparation des paramètres
            ...
            vppParamTYPEOPERATION.Value  = clsCtsinistrechequephoto.TYPEOPERATION;
            ...
            SqlCommand vppSqlCmd = new SqlCommand("PC_CTSINISTRECHEQUEPHOTO", clsDonnee.vogObjetConnexionLocal, clsDonnee.vogObjetTransactionLocal);
		...
		///<param name="vppCritere">critères de la requête scalaire</param>
		///<author>Home Technology</author>
		public void pvgUpdate(clsDonnee clsDonnee, clsCtsinistrechequephoto clsCtsinistrechequephoto,params string[] vppCritere)
		{
			//Préparation des paramètres
			SqlParameter vppParamAG_CODEAGENCE = new SqlParameter("@AG_CODEAGENCE", SqlDbType.VarChar, 25);
			vppParamAG_CODEAGENCE.Value  = clsCtsinistrechequephoto.AG_CODEAGENCE ;
			...
			//Préparation de la commande
			 this.vapRequete = "EXECUTE PC_CTSINISTRECHEQUEPHOTO  @AG_CODEAGENCE, @CH_DATESAISIECHEQUE, @CH_IDEXCHEQUE, @CH_NUMSEQUENCEPHOTO, @CH_CHEMINPHOTOCHEQUE, @CH_LIBELLEPHOTOCHEQUE, @CODECRYPTAGE, 1,'' ";
			SqlCommand vppSqlCmd = new SqlCommand(this.vapRequete, clsDonnee.vogObjetConnexionLocal, clsDonnee.vogObjetTransactionLocal);
		...
		public void pvgDelete(clsDonnee clsDonnee,params string[] vppCritere)
		{
			pvpChoixCritere(clsDonnee ,vppCritere);
			//Préparation de la commande
			 this.vapRequete = "EXECUTE PC_CTSINISTRECHEQUEPHOTO  @AG_CODEAGENCE, @CH_DATESAISIECHEQUE, @CH_IDEXCHEQUE, @CH_NUMSEQUENCEPHOTO, '' , '' , @CODECRYPTAGE, 2,'' ";
			SqlCommand vppSqlCmd = new SqlCommand(this.vapRequete, clsDonnee.vogObjetConnexionLocal, clsDonnee.vogObjetTransactionLocal);
		...
		public void pvgDeleteListe(clsDonnee clsDonnee,params string[] vppCritere)
		{
			pvpChoixCritere(clsDonnee ,vppCritere);
			//Préparation de la commande
			 this.vapRequete = "EXECUTE PC_CTSINISTRECHEQUEPHOTO  @AG_CODEAGENCE, @CH_DATESAISIECHEQUE, @CH_IDEXCHEQUE, '', '' , '' , @CODECRYPTAGE, 3,'' ";
			SqlCommand vppSqlCmd = new SqlCommand(this.vapRequete, clsDonnee.vogObjetConnexionLocal, clsDonnee.vogObjetTransactionLocal);
		...
		///<author>Home Technology</author>
		public List<clsCtsinistrechequephoto> pvgSelect(clsDonnee clsDonnee, params string[] vppCritere)
		{
			pvpChoixCritere(clsDonnee ,vppCritere);
			this.vapRequete = "SELECT  AG_CODEAGENCE, CH_DATESAISIECHEQUE, CH_IDEXCHEQUE, CH_NUMSEQUENCEPHOTO, CH_CHEMINPHOTOCHEQUE, CH_LIBELLEPHOTOCHEQUE FROM dbo.FT_CTSINISTRECHEQUEPHOTO(@CODECRYPTAGE) " + this.vapCritere;
			this.vapCritere="";			SqlCommand vppSqlCmd = new SqlCommand(this.vapRequete, clsDonnee.vogObjetConnexionLocal, clsDonnee.vogObjetTransactionLocal);
			List<clsCtsinistrechequephoto> clsCtsinistrechequephotos = new List<clsCtsinistrechequephoto>();
			if(clsDonnee.pvgRemplirDataReader(vppSqlCmd, vapNomParametre, vapValeurParametre))
			{
				while(clsDonnee.vogDataReader.Read())
				{
					clsCtsinistrechequephoto clsCtsinistrechequephoto = new clsCtsinistrechequephoto();
					clsCtsinistrechequephoto.AG_CODEAGENCE = clsDonnee.vogDataReader["AG_CODEAGENCE"].ToString();
					clsCtsinistrechequephoto.CH_DATESAISIECHEQUE = DateTime.Parse(clsDonnee.vogDataReader["CH_DATESAISIECHEQUE"].ToString());
					clsCtsinistrechequephoto.CH_IDEXCHEQUE = clsDonnee.vogDataReader["CH_IDEXCHEQUE"].ToString();
					clsCtsinistrechequephoto.CH_NUMSEQUENCEPHOTO = clsDonnee.vogDataReader["CH_NUMSEQUENCEPHOTO"].ToString();
					clsCtsinistrechequephoto.CH_CHEMINPHOTOCHEQUE = clsDonnee.vogDataReader["CH_CHEMINPHOTOCHEQUE"].ToString();
					clsCtsinistrechequephoto.CH_LIBELLEPHOTOCHEQUE = clsDonnee.vogDataReader["CH_LIBELLEPHOTOCHEQUE"].ToString();
		...
		///<returns>Une collection de clsCtsinistrechequephoto </returns>
		///<author>Home Technology</author>
		public List<clsCtsinistrechequephoto> pvgSelectDataSet(clsDonnee clsDonnee, params string[] vppCritere)
		{
			List<clsCtsinistrechequephoto> clsCtsinistrechequephotos = new List<clsCtsinistrechequephoto>();
			...
			if(int.Parse(clsDonnee.vagNombreLigneRequete)>0)
			{
				...
				{
					clsCtsinistrechequephoto clsCtsinistrechequephoto = new clsCtsinistrechequephoto();
					clsCtsinistrechequephoto.AG_CODEAGENCE = Dataset.Tables["TABLE"].Rows[Idx]["AG_CODEAGENCE"].ToString();
					clsCtsinistrechequephoto.CH_DATESAISIECHEQUE = DateTime.Parse(Dataset.Tables["TABLE"].Rows[Idx]["CH_DATESAISIECHEQUE"].ToString());
					clsCtsinistrechequephoto.CH_IDEXCHEQUE = Dataset.Tables["TABLE"].Rows[Idx]["CH_IDEXCHEQUE"].ToString();
					clsCtsinistrechequephoto.CH_NUMSEQUENCEPHOTO = Dataset.Tables["TABLE"].Rows[Idx]["CH_NUMSEQUENCEPHOTO"].ToString();
					clsCtsinistrechequephoto.CH_CHEMINPHOTOCHEQUE = Dataset.Tables["TABLE"].Rows[Idx]["CH_CHEMINPHOTOCHEQUE"].ToString();
					clsCtsinistrechequephoto.CH_LIBELLEPHOTOCHEQUE = Dataset.Tables["TABLE"].Rows[Idx]["CH_LIBELLEPHOTOCHEQUE"].ToString();
					clsCtsinistrechequephotos.Add(clsCtsinistrechequephoto);
				}
				Dataset.Dispose();
			}
		...
		public DataSet pvgChargerDansDataSet(clsDonnee clsDonnee, params string[] vppCritere)
		{
            ...
            DataSet DataSet = new DataSet();
            vapNomParametre = new string[] { "@CODECRYPTAGE", "@AG_CODEAGENCE", "@CH_DATESAISIECHEQUE", "@CH_IDEXCHEQUE", "@SI_CODESINISTRE", "@OP_CODEOPERATEUREDITION", "@TYPEOPERATION" };
            ...
            this.vapRequete = "EXEC PS_CTSINISTRECHEQUEPHOTO @AG_CODEAGENCE,@CH_DATESAISIECHEQUE,@CH_IDEXCHEQUE,@SI_CODESINISTRE,@OP_CODEOPERATEUREDITION,@TYPEOPERATION,@CODECRYPTAGE " ;
			this.vapCritere = "";
			SqlCommand vppSqlCmd = new SqlCommand(this.vapRequete, clsDonnee.vogObjetConnexionLocal, clsDonnee.vogObjetTransactionLocal);
        ...
        DataSet DataSet = new DataSet();
        vapNomParametre = new string[] { "@CODECRYPTAGE", "@AG_CODEAGENCE",  "@SI_CODESINISTRE", "@OP_CODEOPERATEUREDITION", "@TYPEOPERATION" };
        vapValeurParametre = new object[] { clsDonnee.vogCleCryptage, vppCritere[0], vppCritere[1], vppCritere[2], vppCritere[3],  };
        this.vapRequete = "EXEC PS_CTSINISTRECHEQUEPHOTOAFFICHER @AG_CODEAGENCE,@SI_CODESINISTRE,@OP_CODEOPERATEUREDITION,@TYPEOPERATION,@CODECRYPTAGE ";
        this.vapCritere = "";
        SqlCommand vppSqlCmd = new SqlCommand(this.vapRequete, clsDonnee.vogObjetConnexionLocal, clsDonnee.vogObjetTransactionLocal);
        DataSet = clsDonnee.pvgRemplirDataset(vppSqlCmd, vapNomParametre, vapValeurParametre, true);
        for (int Idx = 0; Idx < DataSet.Tables[0].Rows.Count; Idx++)
        ...
        {
            pvpChoixCritere(clsDonnee, vppCritere);
            this.vapRequete = "SELECT AG_CODEAGENCE , CH_CHEMINPHOTOCHEQUE FROM dbo.FT_CTSINISTRECHEQUEPHOTO(@CODECRYPTAGE) " + this.vapCritere;
            this.vapCritere = "";
            SqlCommand vppSqlCmd = new SqlCommand(this.vapRequete, clsDonnee.vogObjetConnexionLocal, clsDonnee.vogObjetTransactionLocal);
            return clsDonnee.pvgRemplirDataset(vppSqlCmd, vapNomParametre, vapValeurParametre, true);
        }
