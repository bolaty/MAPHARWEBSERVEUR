...
{
	public class clsLogicielobjetWSDAL: ITableDAL<clsLogicielobjet>
	{
		...
		///<author>Home Technology</author>
		public clsLogicielobjet pvgTableLabel(clsDonnee clsDonnee, params string[] vppCritere)
		{
			pvpChoixCritere(clsDonnee ,vppCritere);
			...
			this.vapCritere = "";
			SqlCommand vppSqlCmd = new SqlCommand(this.vapRequete, clsDonnee.vogObjetConnexionLocal, clsDonnee.vogObjetTransactionLocal);
			clsLogicielobjet clsLogicielobjet = new clsLogicielobjet();
			if(clsDonnee.pvgRemplirDataReader(vppSqlCmd, vapNomParametre, vapValeurParametre))
			{
				while(clsDonnee.vogDataReader.Read())
				{
					clsLogicielobjet.OT_CODETYPEOBJET = clsDonnee.vogDataReader["OT_CODETYPEOBJET"].ToString();
					clsLogicielobjet.OB_NOMOBJET = clsDonnee.vogDataReader["OB_NOMOBJET"].ToString();
					clsLogicielobjet.LO_CODELOGICIEL = clsDonnee.vogDataReader["LO_CODELOGICIEL"].ToString();
					clsLogicielobjet.OB_LIBELLE = clsDonnee.vogDataReader["OB_LIBELLE"].ToString();
					clsLogicielobjet.OB_STATUT = clsDonnee.vogDataReader["OB_STATUT"].ToString();
					clsLogicielobjet.OB_RATTACHEA = int.Parse(clsDonnee.vogDataReader["OB_RATTACHEA"].ToString());
				}
				clsDonnee.vogDataReader.Dispose();
			}
		return clsLogicielobjet;
		}
		...
		///<param name="vppCritere">critères de la requête scalaire</param>
		///<author>Home Technology</author>
		public void pvgUpdate(clsDonnee clsDonnee, clsLogicielobjet clsLogicielobjet,params string[] vppCritere)
		{
			//Préparation des paramètres
			SqlParameter vppParamOT_CODETYPEOBJET = new SqlParameter("@OT_CODETYPEOBJET", SqlDbType.VarChar, 25);
			vppParamOT_CODETYPEOBJET.Value  = clsLogicielobjet.OT_CODETYPEOBJET ;
		...
		///<author>Home Technology</author>
		public List<clsLogicielobjet> pvgSelect(clsDonnee clsDonnee, params string[] vppCritere)
		{
			pvpChoixCritere(clsDonnee ,vppCritere);
			this.vapRequete = "SELECT  OT_CODETYPEOBJET, OB_CODEOBJET, OB_NOMOBJET, LO_CODELOGICIEL, OB_LIBELLE, OB_STATUT, OB_RATTACHEA FROM dbo.FT_LOGICIELOBJETWEB(@CODECRYPTAGE) " + this.vapCritere;
			this.vapCritere="";			SqlCommand vppSqlCmd = new SqlCommand(this.vapRequete, clsDonnee.vogObjetConnexionLocal, clsDonnee.vogObjetTransactionLocal);
			List<clsLogicielobjet> clsLogicielobjets = new List<clsLogicielobjet>();
			if(clsDonnee.pvgRemplirDataReader(vppSqlCmd, vapNomParametre, vapValeurParametre))
			{
				while(clsDonnee.vogDataReader.Read())
				{
					clsLogicielobjet clsLogicielobjet = new clsLogicielobjet();
					clsLogicielobjet.OT_CODETYPEOBJET = clsDonnee.vogDataReader["OT_CODETYPEOBJET"].ToString();
					clsLogicielobjet.OB_CODEOBJET = clsDonnee.vogDataReader["OB_CODEOBJET"].ToString();
					clsLogicielobjet.OB_NOMOBJET = clsDonnee.vogDataReader["OB_NOMOBJET"].ToString();
					clsLogicielobjet.LO_CODELOGICIEL = clsDonnee.vogDataReader["LO_CODELOGICIEL"].ToString();
					clsLogicielobjet.OB_LIBELLE = clsDonnee.vogDataReader["OB_LIBELLE"].ToString();
					clsLogicielobjet.OB_STATUT = clsDonnee.vogDataReader["OB_STATUT"].ToString();
		...
		///<returns>Une collection de clsLogicielobjet </returns>
		///<author>Home Technology</author>
		public List<clsLogicielobjet> pvgSelectDataSet(clsDonnee clsDonnee, params string[] vppCritere)
		{
			List<clsLogicielobjet> clsLogicielobjets = new List<clsLogicielobjet>();
			...
			if(int.Parse(clsDonnee.vagNombreLigneRequete)>0)
			{
				...
				{
					clsLogicielobjet clsLogicielobjet = new clsLogicielobjet();
					clsLogicielobjet.OT_CODETYPEOBJET = Dataset.Tables["TABLE"].Rows[Idx]["OT_CODETYPEOBJET"].ToString();
					clsLogicielobjet.OB_CODEOBJET = Dataset.Tables["TABLE"].Rows[Idx]["OB_CODEOBJET"].ToString();
					clsLogicielobjet.OB_NOMOBJET = Dataset.Tables["TABLE"].Rows[Idx]["OB_NOMOBJET"].ToString();
					clsLogicielobjet.LO_CODELOGICIEL = Dataset.Tables["TABLE"].Rows[Idx]["LO_CODELOGICIEL"].ToString();
					clsLogicielobjet.OB_LIBELLE = Dataset.Tables["TABLE"].Rows[Idx]["OB_LIBELLE"].ToString();
					clsLogicielobjet.OB_STATUT = Dataset.Tables["TABLE"].Rows[Idx]["OB_STATUT"].ToString();
					clsLogicielobjet.OB_RATTACHEA = int.Parse(Dataset.Tables["TABLE"].Rows[Idx]["OB_RATTACHEA"].ToString());
					clsLogicielobjets.Add(clsLogicielobjet);
				}
				Dataset.Dispose();
			}
		...
		{
			pvpChoixCritere(clsDonnee ,vppCritere);
			this.vapRequete = "SELECT *  FROM dbo.FT_LOGICIELOBJETWEB(@CODECRYPTAGE) " + this.vapCritere;
			this.vapCritere = "";
			SqlCommand vppSqlCmd = new SqlCommand(this.vapRequete, clsDonnee.vogObjetConnexionLocal, clsDonnee.vogObjetTransactionLocal);
		...
		public DataSet pvgChargerDansDataSetPourCombo(clsDonnee clsDonnee, params string[] vppCritere)
		{
            ...
            this.vapRequete = "SELECT OB_RATTACHEA , OB_LIBELLE,OB_CODEOBJET FROM dbo.FT_LOGICIELOBJETWEB(@CODECRYPTAGE) " + this.vapCritere;
			this.vapCritere = "";
			SqlCommand vppSqlCmd = new SqlCommand(this.vapRequete, clsDonnee.vogObjetConnexionLocal, clsDonnee.vogObjetTransactionLocal);
			return clsDonnee.pvgRemplirDataset(vppSqlCmd, vapNomParametre, vapValeurParametre,true);
		}
