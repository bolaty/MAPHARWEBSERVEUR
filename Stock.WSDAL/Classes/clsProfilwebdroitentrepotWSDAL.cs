...
{
	public class clsProfilwebdroitentrepotWSDAL: ITableDAL<clsProfilwebdroitentrepot>
	{
		...
		public string pvgValueScalarRequeteCount(clsDonnee clsDonnee, params string[] vppCritere)
		{
			...
			this.vapRequete = "SELECT COUNT(PO_CODEPROFILWEB) AS PO_CODEPROFILWEB  FROM dbo.Profilwebdroitentrepot " + this.vapCritere;
			this.vapCritere = "";
		...
		{
			pvpChoixCritere(vppCritere);
			this.vapRequete = "SELECT MIN(PO_CODEPROFILWEB) AS PO_CODEPROFILWEB  FROM dbo.Profilwebdroitentrepot " + this.vapCritere;
			this.vapCritere = "";
			SqlCommand vppSqlCmd = new SqlCommand(this.vapRequete, clsDonnee.vogObjetConnexionLocal, clsDonnee.vogObjetTransactionLocal);
			return clsDonnee.pvgValueScalarRequete(vppSqlCmd, vapNomParametre, vapValeurParametre);
		}
		...
		{
			pvpChoixCritere(vppCritere);
			this.vapRequete = "SELECT MAX(PO_CODEPROFILWEB) AS PO_CODEPROFILWEB  FROM dbo.Profilwebdroitentrepot " + this.vapCritere;
			this.vapCritere = "";
			SqlCommand vppSqlCmd = new SqlCommand(this.vapRequete, clsDonnee.vogObjetConnexionLocal, clsDonnee.vogObjetTransactionLocal);
			return clsDonnee.pvgValueScalarRequete(vppSqlCmd, vapNomParametre, vapValeurParametre);
		}
		...
		///<author>Home Technology</author>
		public clsProfilwebdroitentrepot pvgTableLabel(clsDonnee clsDonnee, params string[] vppCritere)
		{
			pvpChoixCritere(vppCritere);
			this.vapRequete = "SELECT EN_CODEENTREPOT  FROM dbo.Profilwebdroitentrepot " + this.vapCritere;
			this.vapCritere = "";
			SqlCommand vppSqlCmd = new SqlCommand(this.vapRequete, clsDonnee.vogObjetConnexionLocal, clsDonnee.vogObjetTransactionLocal);
			clsProfilwebdroitentrepot clsProfilwebdroitentrepot = new clsProfilwebdroitentrepot();
			if(clsDonnee.pvgRemplirDataReader(vppSqlCmd, vapNomParametre, vapValeurParametre))
			{
				while(clsDonnee.vogDataReader.Read())
				{
					clsProfilwebdroitentrepot.EN_CODEENTREPOT = clsDonnee.vogDataReader["EN_CODEENTREPOT"].ToString();
				}
				clsDonnee.vogDataReader.Dispose();
			}
		return clsProfilwebdroitentrepot;
		}
		...
		///<author>Home Technology</author>
		public void pvgInsert(clsDonnee clsDonnee, clsProfilwebdroitentrepot clsProfilwebdroitentrepot)
		{
			//Préparation des paramètres
			SqlParameter vppParamPO_CODEPROFILWEB = new SqlParameter("@PO_CODEPROFILWEB1", SqlDbType.VarChar, 25);
			vppParamPO_CODEPROFILWEB.Value  = clsProfilwebdroitentrepot.PO_CODEPROFILWEB ;
			SqlParameter vppParamEN_CODEENTREPOT = new SqlParameter("@EN_CODEENTREPOT", SqlDbType.VarChar, 25);
			vppParamEN_CODEENTREPOT.Value  = clsProfilwebdroitentrepot.EN_CODEENTREPOT ;

			//Préparation de la commande
			 this.vapRequete = "INSERT INTO Profilwebdroitentrepot (  PO_CODEPROFILWEB, EN_CODEENTREPOT) " +
		...
		///<param name="vppCritere">critères de la requête scalaire</param>
		///<author>Home Technology</author>
		public void pvgUpdate(clsDonnee clsDonnee, clsProfilwebdroitentrepot clsProfilwebdroitentrepot,params string[] vppCritere)
		{
			//Préparation des paramètres
			SqlParameter vppParamEN_CODEENTREPOT = new SqlParameter("@EN_CODEENTREPOT", SqlDbType.VarChar, 25);
			vppParamEN_CODEENTREPOT.Value  = clsProfilwebdroitentrepot.EN_CODEENTREPOT ;
			...
			//Préparation de la commande
			 pvpChoixCritere(vppCritere); 
			 this.vapRequete = "UPDATE Profilwebdroitentrepot SET " +
		...
		public void pvgDelete(clsDonnee clsDonnee,params string[] vppCritere)
		{
			pvpChoixCritere(vppCritere);
			//Préparation de la commande
			 this.vapRequete = "DELETE FROM  Profilwebdroitentrepot "+ this.vapCritere;;
			this.vapCritere = "";
			SqlCommand vppSqlCmd = new SqlCommand(this.vapRequete, clsDonnee.vogObjetConnexionLocal, clsDonnee.vogObjetTransactionLocal);
		...
		///<author>Home Technology</author>
		public List<clsProfilwebdroitentrepot> pvgSelect(clsDonnee clsDonnee, params string[] vppCritere)
		{
			pvpChoixCritere(vppCritere);
			this.vapRequete = "SELECT  PO_CODEPROFILWEB, EN_CODEENTREPOT FROM dbo.Profilwebdroitentrepot " + this.vapCritere;
			this.vapCritere="";			SqlCommand vppSqlCmd = new SqlCommand(this.vapRequete, clsDonnee.vogObjetConnexionLocal, clsDonnee.vogObjetTransactionLocal);
			List<clsProfilwebdroitentrepot> clsProfilwebdroitentrepots = new List<clsProfilwebdroitentrepot>();
			if(clsDonnee.pvgRemplirDataReader(vppSqlCmd, vapNomParametre, vapValeurParametre))
			{
				while(clsDonnee.vogDataReader.Read())
				{
					clsProfilwebdroitentrepot clsProfilwebdroitentrepot = new clsProfilwebdroitentrepot();
					clsProfilwebdroitentrepot.PO_CODEPROFILWEB = clsDonnee.vogDataReader["PO_CODEPROFILWEB"].ToString();
					clsProfilwebdroitentrepot.EN_CODEENTREPOT = clsDonnee.vogDataReader["EN_CODEENTREPOT"].ToString();
		...
		///<returns>Une collection de clsProfilwebdroitentrepot </returns>
		///<author>Home Technology</author>
		public List<clsProfilwebdroitentrepot> pvgSelectDataSet(clsDonnee clsDonnee, params string[] vppCritere)
		{
			List<clsProfilwebdroitentrepot> clsProfilwebdroitentrepots = new List<clsProfilwebdroitentrepot>();
			...
			if(int.Parse(clsDonnee.vagNombreLigneRequete)>0)
			{
				...
				{
					clsProfilwebdroitentrepot clsProfilwebdroitentrepot = new clsProfilwebdroitentrepot();
					clsProfilwebdroitentrepot.PO_CODEPROFILWEB = Dataset.Tables["TABLE"].Rows[Idx]["PO_CODEPROFILWEB"].ToString();
					clsProfilwebdroitentrepot.EN_CODEENTREPOT = Dataset.Tables["TABLE"].Rows[Idx]["EN_CODEENTREPOT"].ToString();
					clsProfilwebdroitentrepots.Add(clsProfilwebdroitentrepot);
				}
				Dataset.Dispose();
			}
		...
		public DataSet pvgChargerDansDataSet(clsDonnee clsDonnee, params string[] vppCritere)
		{
            ...
            this.vapRequete = "SELECT *  FROM dbo.[FC_Profilwebdroitentrepot](@PO_CODEPROFILWEB,@CODECRYPTAGE) ";
            SqlCommand vppSqlCmd = new SqlCommand(this.vapRequete, clsDonnee.vogObjetConnexionLocal, clsDonnee.vogObjetTransactionLocal);
