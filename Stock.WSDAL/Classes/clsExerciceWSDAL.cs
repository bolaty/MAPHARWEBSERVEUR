...
namespace Stock.WSDAL
{
	...
	public class clsExerciceWSDAL : ITableDAL<clsExercice>
	{
        ...
        ///<returns>Un string comme valeur du résultat de la requete</returns>
        ///<author>Home Technologie</author>
        public string pvgValueScalarRequeteMin1(clsDonnee clsDonnee, params string[] vppCritere)
        {
            pvpChoixCritere(vppCritere);
            this.vapRequete = "SELECT MIN(EX_DATEDEBUT) AS EX_DATEDEBUT  FROM EXERCICE " + this.vapCritere;
            this.vapCritere = "";
		...
		{
			pvpChoixCritere(vppCritere);
            this.vapRequete = "SELECT JT_DATEJOURNEETRAVAIL,EX_DATEDEBUT,EX_DATEFIN,EX_DESCEXERCICE,EX_ETATEXERCICE,EX_DATESAISIE FROM EXERCICE " + this.vapCritere;
			vapCritere = "";
		...
		public void pvgInsert(clsDonnee clsDonnee,clsExercice clsExercice)
		{
			...
			SqlParameter vppParamEX_EXERCICEENCOURS = new SqlParameter("@EX_EXERCICEENCOURS", SqlDbType.VarChar, 1);
            vppParamEX_EXERCICEENCOURS.Value = clsExercice.EX_EXERCICEENCOURS;
			...
			this.vapRequete = "INSERT INTO EXERCICE " +
            " (AG_CODEAGENCE,EX_EXERCICE,JT_DATEJOURNEETRAVAIL,EX_DATEDEBUT,EX_DATEFIN,EX_DESCEXERCICE,EX_ETATEXERCICE, EX_EXERCICEENCOURS, EX_DATESAISIE)" +
            " VALUES(@AG_CODEAGENCE,@EX_EXERCICE,@JT_DATEJOURNEETRAVAIL,@EX_DATEDEBUT,@EX_DATEFIN,@EX_DESCEXERCICE,@EX_ETATEXERCICE,@EX_EXERCICEENCOURS, @EX_DATESAISIE)";
			SqlCommand vppSqlCmd = new SqlCommand(this.vapRequete, clsDonnee.vogObjetConnexionLocal, clsDonnee.vogObjetTransactionLocal);
			...
			vppSqlCmd.Parameters.Add(vppParamEX_EXERCICEENCOURS);
		...
		public void pvgUpdate(clsDonnee clsDonnee , clsExercice clsExercice, params string[] vppCritere)
		{
			...
			" AG_CODEAGENCE = @AG_CODEAGENCE1 , " +
            " JT_DATEJOURNEETRAVAIL = @JT_DATEJOURNEETRAVAIL , " + 
			" EX_DATEDEBUT = @EX_DATEDEBUT , " + 
			" EX_DATEFIN = @EX_DATEFIN , " + 
			" EX_DESCEXERCICE = @EX_DESCEXERCICE , " + 
			" EX_ETATEXERCICE = @EX_ETATEXERCICE , " +
            " EX_EXERCICEENCOURS = @EX_EXERCICEENCOURS , " + 
			" EX_DATESAISIE = @EX_DATESAISIE" + this.vapCritere ;
        ...
        ///<param name="vppCritere">Les critères de modification</param>
        ///<author>Home Technologie</author>
        public void pvgUpdateEXERCICEENCOURS(clsDonnee clsDonnee, clsExercice clsExercice, params string[] vppCritere)
        {
            //Préparation des paramètres
            ...
            //Préparation de la commande
            this.vapRequete = "UPDATE EXERCICE SET " +
            " EX_EXERCICEENCOURS = @EX_EXERCICEENCOURS" + this.vapCritere;
        ...
        ///<returns>DataSet</returns>
        ///<author>Home Technologie</author>
        public DataSet pvgChargerDansDataSetExerciceEncours(clsDonnee clsDonnee, params string[] vppCritere)
        {
            vapNomParametre = new string[] { "@AG_CODEAGENCE" };
            vapValeurParametre = new object[] { vppCritere[0] };
            this.vapRequete = "SELECT  TOP 1 * FROM  dbo.EXERCICE GROUP BY AG_CODEAGENCE,EX_EXERCICE,JT_DATEJOURNEETRAVAIL,EX_DATEDEBUT,EX_DATEFIN,EX_DESCEXERCICE,EX_ETATEXERCICE,EX_DATESAISIE,EX_DATEDEBUTBILAN,EX_DATEFINBILAN,EX_DATEAFFECTATIONRESULTAT,EX_EXERCICEENCOURS HAVING AG_CODEAGENCE=@AG_CODEAGENCE AND EX_EXERCICEENCOURS='O'  ORDER BY  EX_EXERCICE DESC";
            this.vapCritere = "";
            SqlCommand vppSqlCmd = new SqlCommand(this.vapRequete, clsDonnee.vogObjetConnexionLocal, clsDonnee.vogObjetTransactionLocal);
            return clsDonnee.pvgRemplirDataset(vppSqlCmd, vapNomParametre, vapValeurParametre, true);
        }
