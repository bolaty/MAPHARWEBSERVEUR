...
namespace Stock.WSDAL
{
	...
	public class clsEditionWSDAL 
	{
        ...
        public DataSet pvgChargerDansDataSetPourComboAgenceEdition(clsDonnee clsDonnee, params string[] vppCritere)
        {
            ...
            this.vapRequete = "EXEC PS_COMBOAGENCEWEB @EX_EXERCICE,@SO_CODESOCIETE,@ZN_CODEZONE,@AG_CODEAGENCE,@OP_CODEOPERATEUR,@CODECRYPTAGE ";
            this.vapCritere = "";
		...
		{
            this.vapRequete = "SELECT * FROM VUE_AGENCE ";
            ...
            switch (vppCritere.Length)
            {
                ...
                case 3:
                    ...
                    vapNomParametre = new string[] { "@EX_EXERCICE", "@SO_CODESOCIETE", "@ZN_CODEZONE" };
                    vapValeurParametre = new object[] { vppCritere[0], vppCritere[1], vppCritere[2] };
                    break;
                case 4:
                    this.vapRequete += " WHERE EX_EXERCICE=@EX_EXERCICE AND SO_CODESOCIETE = @SO_CODESOCIETE AND ZN_CODEZONE LIKE '%'+@ZN_CODEZONE+'%' AND AG_AGENCECODE LIKE '%'+@AG_AGENCECODE+'%' ";
                    vapNomParametre = new string[] { "@EX_EXERCICE", "@SO_CODESOCIETE", "@ZN_CODEZONE", "@AG_AGENCECODE" };
        ...
        public DataSet pvgMois(clsDonnee clsDonnee, params string[] vppCritere)
        {

            //vapNomParametre = new string[] { "@PP_CODEPARAMETRE" };
            //vapValeurParametre = new object[] { vppCritere[0] };
            this.vapRequete = " SELECT MO_CODEMOIS,MO_LIBELLE,MO_TRIMESTRIEL,MO_SEMESTRIEL,MO_ANNUEL from MOIS WHERE "+ vppCritere[0];
            SqlCommand vppSqlCmd = new SqlCommand(this.vapRequete, clsDonnee.vogObjetConnexionLocal, clsDonnee.vogObjetTransactionLocal);
            return clsDonnee.pvgRemplirDataset(vppSqlCmd, vapNomParametre, vapValeurParametre, true);
        }
