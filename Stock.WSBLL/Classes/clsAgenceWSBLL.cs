...
namespace Stock.WSBLL
{
	...
	public class clsAgenceWSBLL : IObjetWSBLL<clsAgence>
	{
		...
		///<returns>clsAgence </returns>
		///<author>Home Technologie</author>
        public clsAgence pvgTableLabelAG_AGENCECODE(clsDonnee clsDonnee, clsObjetEnvoi clsObjetEnvoi)
		{
            return clsAgenceWSDAL.pvgTableLabelAG_AGENCECODE(clsDonnee, clsObjetEnvoi.OE_PARAM);
		}
		...
		///<returns>clsAgence </returns>
		///<author>Home Technologie</author>
        public clsAgence pvgTableLabelAG_RAISONSOCIAL(clsDonnee clsDonnee, clsObjetEnvoi clsObjetEnvoi)
		{
            return clsAgenceWSDAL.pvgTableLabelAG_RAISONSOCIAL(clsDonnee, clsObjetEnvoi.OE_PARAM);
		}
		...
		{
			clsAgence.AG_CODEAGENCE = (double.Parse(clsAgenceWSDAL.pvgValueScalarRequeteMax(clsDonnee)) + 1).ToString();
        ...
        public DataSet pvgChargerDansDataSetExclusion(clsDonnee clsDonnee, clsObjetEnvoi clsObjetEnvoi)
		{
            return clsAgenceWSDAL.pvgChargerDansDataSetExclusion(clsDonnee, clsObjetEnvoi.OE_PARAM);
		}
		...
		{
			return clsAgenceWSDAL.pvgChargerDansDataSetAgence(clsDonnee , clsObjetEnvoi.OE_PARAM);
		}
