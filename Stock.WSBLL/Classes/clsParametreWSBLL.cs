...
namespace Stock.WSBLL
{
	...
	public class clsParametreWSBLL : IObjetWSBLL<clsParametre>
	{
        ...
        {
            return clsParametreWSDAL.pvgCommissioncinetpay(clsDonnee, MONTANT, MONTANTMF, SL_TYPEOPERATION, LG_CODELANGUE);
        }
		...
		{
			return clsParametreWSDAL.pvgTestCheminRepertoirePhotoSignature(clsDonnee , PP_CODEPARAMETRE);
		}
