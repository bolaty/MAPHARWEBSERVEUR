...
{
	public class clsPhamouvementstockfiltragedestock : clsEntitieBase
    {
		...
		private string _MF_DATESAISIEFILTRAGEDESTOCK = "01/01/1900";
		private string _MF_DATECLOTUREFILTRAGEDESTOCK = "01/01/1900";
		...
		public string MF_DATESAISIEFILTRAGEDESTOCK
		{
			get { return _MF_DATESAISIEFILTRAGEDESTOCK; }
			set {  _MF_DATESAISIEFILTRAGEDESTOCK = value; }
		}

		public string MF_DATECLOTUREFILTRAGEDESTOCK
		{
