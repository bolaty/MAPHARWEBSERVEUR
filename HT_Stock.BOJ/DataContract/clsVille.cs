...
{
	public class clsVille : clsEntitieBase
    {
		...
		public clsVille(string PY_CODEPAYS, string VL_CODEVILLE,string ZN_CODEZONE,string VL_LIBELLE,string VL_DESCRIPTION,string VL_REFERENCE)
		{
		...
		{
            PY_CODEPAYS = clsVille.PY_CODEPAYS;
