...
{
	public class clsOrgProspectsPhoto : clsEntitieBase
    {
		#region VARIABLES LOCALES

		private string _AG_CODEAGENCE = "";
		private string _PR_IDTIERS = "";
        private string _PR_PHOTO = null;
        private string _PR_SIGNATURE = null;
        ...
        public clsOrgProspectsPhoto(string AG_CODEAGENCE, string PR_IDTIERS, string PR_PHOTO, string PR_SIGNATURE)
		{
