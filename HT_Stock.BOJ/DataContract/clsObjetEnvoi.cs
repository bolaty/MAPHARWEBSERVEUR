...
namespace HT_Stock.BOJ
{
	public class clsObjetEnvoi
	{
        ...
        private string _OE_G = "";// 
        private DateTime _OE_H = DateTime.Parse("01/01/1900");// 
        ...
        public clsObjetEnvoi(string OE_A, string OE_O, string OE_D, string OE_X,
            string OE_Y, string OE_M, bool OE_Z, string OE_R, string OE_E, string OE_Q, DateTime OE_J, DateTime OE_S, string OE_U, string OE_T, string OE_G, DateTime OE_H, string[] OE_PARAM)
        {
        ...
        public clsObjetEnvoi SetValue(string OE_A, string OE_O, string OE_D, string OE_X,
            bool OE_Z, string OE_R, string OE_E, string OE_Q, DateTime OE_J, DateTime OE_S, string OE_U, string OE_T, string OE_G, DateTime OE_H, string[] OE_PARAM)
		{
			this.OE_A = OE_A;
            this.OE_O = OE_O;
            this.OE_D = OE_D;
