...
{
	public class clsLogicielobjet : clsEntitieBase
    {
		...
		public clsLogicielobjet( string OT_CODETYPEOBJET,string OB_CODEOBJET,string OB_NOMOBJET,string LO_CODELOGICIEL,string OB_LIBELLE,string OB_STATUT,string OB_RATTACHEA)
		{
