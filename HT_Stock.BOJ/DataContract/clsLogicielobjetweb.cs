...
{
	public class clsLogicielobjetweb : clsEntitieBase
    {
		...
		private string _OB_RATTACHEA = "0";
		...
		public clsLogicielobjetweb( string OT_CODETYPEOBJET,string OB_CODEOBJET,string OB_NOMOBJET,string LO_CODELOGICIEL,string OB_LIBELLE,string OB_STATUT,string OB_RATTACHEA)
		{
