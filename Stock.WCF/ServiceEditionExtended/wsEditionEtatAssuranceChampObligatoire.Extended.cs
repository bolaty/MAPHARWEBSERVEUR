...
namespace Stock.WCF
{
	public partial class wsEditionEtatAssurance
	{
        ...
        public List<HT_Stock.BOJ.clsEditionEtatAssurance> TestChampObligatoireListeAvisReglementPrime(HT_Stock.BOJ.clsEditionEtatAssurance Objet)
        {
        ...
        public List<HT_Stock.BOJ.clsEditionEtatAssurance> TestChampObligatoireListeSynoptique(HT_Stock.BOJ.clsEditionEtatAssurance Objet)
        {
