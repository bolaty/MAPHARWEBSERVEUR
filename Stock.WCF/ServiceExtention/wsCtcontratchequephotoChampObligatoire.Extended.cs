...
namespace Stock.WCF
{
	public partial class wsCtcontratchequephoto
	{
        ...
        public List<HT_Stock.BOJ.clsCtcontratchequephoto> TestChampObligatoireListeReglementCheque(HT_Stock.BOJ.clsCtcontratchequephoto Objet)
        {
        ...
        if (string.IsNullOrEmpty(Objet.TYPEOPERATION))
        {
            ...
            clsCtcontratchequephoto.clsObjetRetour.SL_CODEMESSAGE = clsMessages.MS_CODEMESSAGE;
            clsCtcontratchequephoto.clsObjetRetour.SL_RESULTAT = Common.clsDeclaration.ERROR_RESULTAT;
            clsCtcontratchequephoto.clsObjetRetour.SL_MESSAGE = clsMessages.MS_LIBELLEMESSAGE + ", TYPEOPERATION";
            clsCtcontratchequephotos.Add(clsCtcontratchequephoto);
            return clsCtcontratchequephotos;
        ...
        public List<HT_Stock.BOJ.clsCtcontratchequephoto> TestChampObligatoireListeEtatCheque(HT_Stock.BOJ.clsCtcontratchequephoto Objet)
        {
        ...
        if (string.IsNullOrEmpty(Objet.DATEDEBUT))
        {
            ...
            clsCtcontratchequephoto.clsObjetRetour.SL_CODEMESSAGE = clsMessages.MS_CODEMESSAGE;
            clsCtcontratchequephoto.clsObjetRetour.SL_RESULTAT = Common.clsDeclaration.ERROR_RESULTAT;
            clsCtcontratchequephoto.clsObjetRetour.SL_MESSAGE = clsMessages.MS_LIBELLEMESSAGE + ", DATEDEBUT";
            clsCtcontratchequephotos.Add(clsCtcontratchequephoto);
            return clsCtcontratchequephotos;
        ...
        if (string.IsNullOrEmpty(Objet.DATEFIN))
        {
            ...
            clsCtcontratchequephoto.clsObjetRetour.SL_CODEMESSAGE = clsMessages.MS_CODEMESSAGE;
            clsCtcontratchequephoto.clsObjetRetour.SL_RESULTAT = Common.clsDeclaration.ERROR_RESULTAT;
            clsCtcontratchequephoto.clsObjetRetour.SL_MESSAGE = clsMessages.MS_LIBELLEMESSAGE + ", DATEFIN";
            clsCtcontratchequephotos.Add(clsCtcontratchequephoto);
            return clsCtcontratchequephotos;
