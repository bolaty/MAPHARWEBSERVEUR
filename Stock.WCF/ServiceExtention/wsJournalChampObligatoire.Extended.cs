...
namespace Stock.WCF
{
	public partial class wsJournal
	{
        ...
        public List<HT_Stock.BOJ.clsJournal> TestChampObligatoireListeEcran(HT_Stock.BOJ.clsJournal Objet)
        {
        ...
        if (string.IsNullOrEmpty(Objet.TJ_CODETYPEJOURNAL))
        {
            ...
            clsJournal.clsObjetRetour.SL_CODEMESSAGE = clsMessages.MS_CODEMESSAGE;
            clsJournal.clsObjetRetour.SL_RESULTAT = Common.clsDeclaration.ERROR_RESULTAT;
            clsJournal.clsObjetRetour.SL_MESSAGE = clsMessages.MS_LIBELLEMESSAGE + ", TJ_CODETYPEJOURNAL";
            clsJournals.Add(clsJournal);
            return clsJournals;
        ...
        if (string.IsNullOrEmpty(Objet.TYPEOPERATION))
        {
            ...
            clsJournal.clsObjetRetour.SL_CODEMESSAGE = clsMessages.MS_CODEMESSAGE;
            clsJournal.clsObjetRetour.SL_RESULTAT = Common.clsDeclaration.ERROR_RESULTAT;
            clsJournal.clsObjetRetour.SL_MESSAGE = clsMessages.MS_LIBELLEMESSAGE + ", TYPEOPERATION";
            clsJournals.Add(clsJournal);
            return clsJournals;
        ...
        public List<HT_Stock.BOJ.clsJournal> TestChampObligatoireInsert(HT_Stock.BOJ.clsJournal Objet)
        {
            ...
            HT_Stock.BOJ.clsJournal clsJournal = new HT_Stock.BOJ.clsJournal();
             ...
             if (string.IsNullOrEmpty(Objet.JO_JOURNALCODE))
            {
                clsJournal.clsObjetRetour = new Common.clsObjetRetour();
                clsMessagesWSBLL clsMessagesWSBLL = new clsMessagesWSBLL();
                clsMessages.MS_CODEMESSAGE = Common.clsDeclaration.CODE_TYPE_OP_REQUIS;
                ...
                clsJournal.clsObjetRetour.SL_CODEMESSAGE = clsMessages.MS_CODEMESSAGE;
                clsJournal.clsObjetRetour.SL_RESULTAT = Common.clsDeclaration.ERROR_RESULTAT;
                clsJournal.clsObjetRetour.SL_MESSAGE = clsMessages.MS_LIBELLEMESSAGE + ", JO_JOURNALCODE";
                clsJournals.Add(clsJournal);
                return clsJournals;
        ...
        if (string.IsNullOrEmpty(Objet.EN_CODEENTREPOT))
            {
                ...
                clsJournal.clsObjetRetour.SL_CODEMESSAGE = clsMessages.MS_CODEMESSAGE;
                clsJournal.clsObjetRetour.SL_RESULTAT = Common.clsDeclaration.ERROR_RESULTAT;
                clsJournal.clsObjetRetour.SL_MESSAGE = clsMessages.MS_LIBELLEMESSAGE + ", EN_CODEENTREPOT";
                clsJournals.Add(clsJournal);
                return clsJournals;

            }
            if (string.IsNullOrEmpty(Objet.JO_C))
            {
                clsJournal.clsObjetRetour = new Common.clsObjetRetour();
                clsMessagesWSBLL clsMessagesWSBLL = new clsMessagesWSBLL();
                clsMessages.MS_CODEMESSAGE = Common.clsDeclaration.CODE_TYPE_OP_REQUIS;
                ...
                clsJournal.clsObjetRetour.SL_CODEMESSAGE = clsMessages.MS_CODEMESSAGE;
                clsJournal.clsObjetRetour.SL_RESULTAT = Common.clsDeclaration.ERROR_RESULTAT;
                clsJournal.clsObjetRetour.SL_MESSAGE = clsMessages.MS_LIBELLEMESSAGE + ", JO_C";
                clsJournals.Add(clsJournal);
                return clsJournals;

            }
            if (string.IsNullOrEmpty(Objet.JO_NUMEROORDRE.ToString()))
            {
                clsJournal.clsObjetRetour = new Common.clsObjetRetour();
                clsMessagesWSBLL clsMessagesWSBLL = new clsMessagesWSBLL();
                clsMessages.MS_CODEMESSAGE = Common.clsDeclaration.CODE_TYPE_OP_REQUIS;
                ...
                clsJournal.clsObjetRetour.SL_CODEMESSAGE = clsMessages.MS_CODEMESSAGE;
                clsJournal.clsObjetRetour.SL_RESULTAT = Common.clsDeclaration.ERROR_RESULTAT;
                clsJournal.clsObjetRetour.SL_MESSAGE = clsMessages.MS_LIBELLEMESSAGE + ", JO_NUMEROORDRE";
                clsJournals.Add(clsJournal);
                return clsJournals;
