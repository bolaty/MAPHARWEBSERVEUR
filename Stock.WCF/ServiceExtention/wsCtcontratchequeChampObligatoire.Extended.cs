	...
	public partial class wsCtcontratcheque
	{
        ...
        public List<HT_Stock.BOJ.clsCtcontratcheque> TestChampObligatoireInsert(HT_Stock.BOJ.clsCtcontratcheque Objet)
        {
            ...
            if (string.IsNullOrEmpty(Objet.CH_DATEDEBUTCOUVERTURE))
            {
                ...
                clsCtcontratcheque.clsObjetRetour.SL_CODEMESSAGE = clsMessages.MS_CODEMESSAGE;
                clsCtcontratcheque.clsObjetRetour.SL_RESULTAT = Common.clsDeclaration.ERROR_RESULTAT;
                clsCtcontratcheque.clsObjetRetour.SL_MESSAGE = clsMessages.MS_LIBELLEMESSAGE + ", CH_DATEDEBUTCOUVERTURE";
                clsCtcontratcheques.Add(clsCtcontratcheque);
                return clsCtcontratcheques;
            ...
            if (string.IsNullOrEmpty(Objet.CH_DATEFINCOUVERTURE))
            {
                ...
                clsCtcontratcheque.clsObjetRetour.SL_CODEMESSAGE = clsMessages.MS_CODEMESSAGE;
                clsCtcontratcheque.clsObjetRetour.SL_RESULTAT = Common.clsDeclaration.ERROR_RESULTAT;
                clsCtcontratcheque.clsObjetRetour.SL_MESSAGE = clsMessages.MS_LIBELLEMESSAGE + ", CH_DATEFINCOUVERTURE";
                clsCtcontratcheques.Add(clsCtcontratcheque);
                return clsCtcontratcheques;

            }
            if (string.IsNullOrEmpty(Objet.CH_VALEURCHEQUE.ToString()))
            {
                clsCtcontratcheque.clsObjetRetour = new Common.clsObjetRetour();
                clsMessagesWSBLL clsMessagesWSBLL = new clsMessagesWSBLL();
                clsMessages.MS_CODEMESSAGE = Common.clsDeclaration.CODE_TYPE_OP_REQUIS;
                ...
                clsCtcontratcheque.clsObjetRetour.SL_CODEMESSAGE = clsMessages.MS_CODEMESSAGE;
                clsCtcontratcheque.clsObjetRetour.SL_RESULTAT = Common.clsDeclaration.ERROR_RESULTAT;
                clsCtcontratcheque.clsObjetRetour.SL_MESSAGE = clsMessages.MS_LIBELLEMESSAGE + ", CH_VALEURCHEQUE";
                clsCtcontratcheques.Add(clsCtcontratcheque);
                return clsCtcontratcheques;

            }
            if (string.IsNullOrEmpty(Objet.CH_PRIMEAENCAISSER.ToString()))
            {
                clsCtcontratcheque.clsObjetRetour = new Common.clsObjetRetour();
                clsMessagesWSBLL clsMessagesWSBLL = new clsMessagesWSBLL();
                clsMessages.MS_CODEMESSAGE = Common.clsDeclaration.CODE_TYPE_OP_REQUIS;
                ...
                clsCtcontratcheque.clsObjetRetour.SL_CODEMESSAGE = clsMessages.MS_CODEMESSAGE;
                clsCtcontratcheque.clsObjetRetour.SL_RESULTAT = Common.clsDeclaration.ERROR_RESULTAT;
                clsCtcontratcheque.clsObjetRetour.SL_MESSAGE = clsMessages.MS_LIBELLEMESSAGE + ", CH_PRIMEAENCAISSER";
                clsCtcontratcheques.Add(clsCtcontratcheque);
                return clsCtcontratcheques;

            }

            if (string.IsNullOrEmpty(Objet.CH_DATEANNULATIONCHEQUE))
            {
                clsCtcontratcheque.clsObjetRetour = new Common.clsObjetRetour();
                clsMessagesWSBLL clsMessagesWSBLL = new clsMessagesWSBLL();
                clsMessages.MS_CODEMESSAGE = Common.clsDeclaration.CODE_TYPE_OP_REQUIS;
                ...
                clsCtcontratcheque.clsObjetRetour.SL_CODEMESSAGE = clsMessages.MS_CODEMESSAGE;
                clsCtcontratcheque.clsObjetRetour.SL_RESULTAT = Common.clsDeclaration.ERROR_RESULTAT;
                clsCtcontratcheque.clsObjetRetour.SL_MESSAGE = clsMessages.MS_LIBELLEMESSAGE + ", CH_DATEANNULATIONCHEQUE";
                clsCtcontratcheques.Add(clsCtcontratcheque);
                return clsCtcontratcheques;

            }
            if (string.IsNullOrEmpty(Objet.CH_DATEEMISSIONCHEQUE))
            {
                clsCtcontratcheque.clsObjetRetour = new Common.clsObjetRetour();
                clsMessagesWSBLL clsMessagesWSBLL = new clsMessagesWSBLL();
                clsMessages.MS_CODEMESSAGE = Common.clsDeclaration.CODE_TYPE_OP_REQUIS;
                ...
                clsCtcontratcheque.clsObjetRetour.SL_CODEMESSAGE = clsMessages.MS_CODEMESSAGE;
                clsCtcontratcheque.clsObjetRetour.SL_RESULTAT = Common.clsDeclaration.ERROR_RESULTAT;
                clsCtcontratcheque.clsObjetRetour.SL_MESSAGE = clsMessages.MS_LIBELLEMESSAGE + ", CH_DATEEMISSIONCHEQUE";
                clsCtcontratcheques.Add(clsCtcontratcheque);
                return clsCtcontratcheques;

            }
            if (string.IsNullOrEmpty(Objet.CH_DATEVALIDATIONCHEQUE))
            {
                clsCtcontratcheque.clsObjetRetour = new Common.clsObjetRetour();
                clsMessagesWSBLL clsMessagesWSBLL = new clsMessagesWSBLL();
                clsMessages.MS_CODEMESSAGE = Common.clsDeclaration.CODE_TYPE_OP_REQUIS;
                ...
                clsCtcontratcheque.clsObjetRetour.SL_CODEMESSAGE = clsMessages.MS_CODEMESSAGE;
                clsCtcontratcheque.clsObjetRetour.SL_RESULTAT = Common.clsDeclaration.ERROR_RESULTAT;
                clsCtcontratcheque.clsObjetRetour.SL_MESSAGE = clsMessages.MS_LIBELLEMESSAGE + ", CH_DATEVALIDATIONCHEQUE";
                clsCtcontratcheques.Add(clsCtcontratcheque);
                return clsCtcontratcheques;

            }
            if (string.IsNullOrEmpty(Objet.CH_DATERECEPTIONCHEQUE))
            {
                clsCtcontratcheque.clsObjetRetour = new Common.clsObjetRetour();
                clsMessagesWSBLL clsMessagesWSBLL = new clsMessagesWSBLL();
                clsMessages.MS_CODEMESSAGE = Common.clsDeclaration.CODE_TYPE_OP_REQUIS;
                ...
                clsCtcontratcheque.clsObjetRetour.SL_CODEMESSAGE = clsMessages.MS_CODEMESSAGE;
                clsCtcontratcheque.clsObjetRetour.SL_RESULTAT = Common.clsDeclaration.ERROR_RESULTAT;
                clsCtcontratcheque.clsObjetRetour.SL_MESSAGE = clsMessages.MS_LIBELLEMESSAGE + ", CH_DATERECEPTIONCHEQUE";
                clsCtcontratcheques.Add(clsCtcontratcheque);
                return clsCtcontratcheques;

            }
            if (string.IsNullOrEmpty(Objet.CH_DATEEFFET))
            {
                clsCtcontratcheque.clsObjetRetour = new Common.clsObjetRetour();
                clsMessagesWSBLL clsMessagesWSBLL = new clsMessagesWSBLL();
                clsMessages.MS_CODEMESSAGE = Common.clsDeclaration.CODE_TYPE_OP_REQUIS;
                ...
                clsCtcontratcheque.clsObjetRetour.SL_CODEMESSAGE = clsMessages.MS_CODEMESSAGE;
                clsCtcontratcheque.clsObjetRetour.SL_RESULTAT = Common.clsDeclaration.ERROR_RESULTAT;
                clsCtcontratcheque.clsObjetRetour.SL_MESSAGE = clsMessages.MS_LIBELLEMESSAGE + ", CH_DATEEFFET";
                clsCtcontratcheques.Add(clsCtcontratcheque);
                return clsCtcontratcheques;
        ...
        public List<HT_Stock.BOJ.clsCtcontratcheque> TestChampObligatoireUpdate(HT_Stock.BOJ.clsCtcontratcheque Objet)
        {
            ...
            if (string.IsNullOrEmpty(Objet.TYPEOPERATION))
            {
                ...
                clsCtcontratcheque.clsObjetRetour.SL_CODEMESSAGE = clsMessages.MS_CODEMESSAGE;
                clsCtcontratcheque.clsObjetRetour.SL_RESULTAT = Common.clsDeclaration.ERROR_RESULTAT;
                clsCtcontratcheque.clsObjetRetour.SL_MESSAGE = clsMessages.MS_LIBELLEMESSAGE + ", TYPEOPERATION";
                clsCtcontratcheques.Add(clsCtcontratcheque);
                return clsCtcontratcheques;
