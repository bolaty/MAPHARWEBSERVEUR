...
namespace Stock.WCF
{
	public partial class wsPhaparnaturetiers
	{
        ...
        public List<HT_Stock.BOJ.clsPhaparnaturetiers> TestChampObligatoireListePourEdition(HT_Stock.BOJ.clsPhaparnaturetiers Objet)
        {
            ...
            if (string.IsNullOrEmpty(Objet.TP_CODETYPETIERS))
            {
                ...
                clsPhaparnaturetiers.clsObjetRetour.SL_CODEMESSAGE = clsMessages.MS_CODEMESSAGE;
                clsPhaparnaturetiers.clsObjetRetour.SL_RESULTAT = Common.clsDeclaration.ERROR_RESULTAT;
                clsPhaparnaturetiers.clsObjetRetour.SL_MESSAGE = clsMessages.MS_LIBELLEMESSAGE + ", TP_CODETYPETIERS";
                clsPhaparnaturetierss.Add(clsPhaparnaturetiers);
                return clsPhaparnaturetierss;
