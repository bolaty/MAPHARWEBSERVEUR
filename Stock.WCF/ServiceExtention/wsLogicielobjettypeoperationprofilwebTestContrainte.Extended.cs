...
namespace Stock.WCF
{
	...
	{
        public DataSet TestContrainte(HT_Stock.BOJ.clsLogicielobjettypeoperationprofilweb Objet)
        ...
        public DataSet TestTestContrainteListe(HT_Stock.BOJ.clsLogicielobjettypeoperationprofilweb Objet)
        {
            DataSet DataSet = new DataSet();
            DataTable dt = new DataTable("TABLE");
            dt.Columns.Add(new DataColumn("SL_CODEMESSAGE", typeof(string)));
