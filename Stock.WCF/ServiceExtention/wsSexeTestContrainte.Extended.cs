...
namespace Stock.WCF
{
	...
	{
        public List<HT_Stock.BOJ.clsSexe> TestContrainte(HT_Stock.BOJ.clsSexe Objet)
        ...
        public List<HT_Stock.BOJ.clsSexe> TestTestContrainteListe(HT_Stock.BOJ.clsSexe Objet)
        {
            List<HT_Stock.BOJ.clsSexe> clsSexes = new List<HT_Stock.BOJ.clsSexe>();
            HT_Stock.BOJ.clsSexe clsSexe = new HT_Stock.BOJ.clsSexe();
            clsSexe.clsObjetRetour = new Common.clsObjetRetour();
