MapharApp.controller("ReglementAssuranceAuxiliaireController", [
  "$scope",
  "$http",
  "$q",
  "$location",
  ...
  function ($scope, $http, $q, $location, $sce, $window, $rootScope) {
    ...
    $scope.SL_LIBELLEECRAN = "REGLEMENT CONTRAT SANTE AUXILIARE";
    ...
    $scope.redirectReglementFactureClient = function () {
      $rootScope.retourListe = "santeAuxiliaire";
      window.location.href =
