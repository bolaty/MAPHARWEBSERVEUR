MapharApp.controller("ApprovisionnementStockController", [
  "$scope",
  "$http",
  "$q",
  "$location",
  ...
  function ($scope, $http, $q, $location, $sce, $window, $rootScope) {
    ...
    $scope.listeAnnuler = function () {
      $(document).ready(function () {
        ...
        $("#idNumFour").css("background-color", "#FFFFFF");
        $("#idNomFour").css("background-color", "#FFFFFF");
        $("#idOperateur").css("background-color", "#FFFFFF");
      });
      $scope.FormListAppro = {};
      $scope.FormListAppro.periodeDu = $rootScope.DATE_JOURNEE_DE_TRAVAIL;
      $scope.FormListAppro.periodeAu = $rootScope.DATE_JOURNEE_DE_TRAVAIL;
      $scope.FormListAppro.numBordereau = "";
      $scope.FormListAppro.numFournisseur = "";
    };
