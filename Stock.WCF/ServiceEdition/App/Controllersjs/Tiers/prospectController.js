MapharApp.controller("prospectController", [
  "$scope",
  "$http",
  "$q",
  "$location",
  ...
  function ($scope, $http, $q, $location, $sce, $window, $rootScope) {
    ...
    $scope.afficheListeTiTiers = function (
      ...
      if (
        ...
        $scope.objet_envoie = [
          {
            ...
            PR_DATESAISIE1: $scope.FormListTiTiers.periodeDu,
            // TI_DATESAISIE2: $rootScope.DATE_JOURNEE_DE_TRAVAIL,
            PR_DATESAISIE2: $scope.FormListTiTiers.periodeAu,
            PR_NUMTIERS: numDuTiers,
            PR_DENOMINATION: nomDuTiers,
            SL_LIBELLEECRAN: $scope.SL_LIBELLEECRAN,
            SL_LIBELLEMOUCHARD: $scope.SL_LIBELLEMOUCHARDLISTE,
            TYPEOPERATION: "PROSPECT",
            LG_CODELANGUE: "fr",
            clsObjetEnvoi: {
        ...
        $http
          .post("/LesTiers/ListeDesProspect/", $scope.objet_envoie, {
    ...
    $scope.voirPlusTiTiers = function (info) {
      ...
      $scope.afficheListeProspectPhotoliste($scope.recuperer.PR_IDTIERS);
    };
    //fin voir plus
    ...
    $scope.voirModifDesTiers = function (info) {
      ...
      window.location.href = "#/gestion/modification/prospect";
    };
    //debut acceder a la page de modification
    ...
    $scope.afficheListeProspectPhoto = function (idprospect) {
      ...
      $http
        .post("/ProspectPhoto/ListePhotoProspect/", $scope.objet_envoie, {
          //headers: $scope.headers
        })
        .then(function (reponse) {
          $scope.listephotoprospect = reponse.data;
          /*$scope.tableauimage.push($scope.listephotoprospect[0].PR_PHOTO);
          $scope.tableauimage2.push(
            "data:image/jpeg;base64," + $scope.listephotoprospect[0].PR_PHOTO
          );
          $scope.tableauimages.push($scope.listephotoprospect[0].PR_SIGNATURE);
          $scope.tableauimages2.push(
            "data:image/jpeg;base64," +
              $scope.listephotoprospect[0].PR_SIGNATURE
          );
          setTimeout(function () {
            $scope.afficherimage();
    ...
    $scope.supprimeTiers = function (recupId) {
      ...
      $http
        .post("/LesTiers/SuppressionDesProspect/", $scope.objet_envoie, {
          //headers: $scope.headers
        })
        .then(function (reponse) {
    ...
    $scope.validerFormTiers = function () {
      ...
      if (
        ...
        if ($scope.etatForm == "2") {
          ...
          $scope.PR_IDTIERS = $scope.recuperer.PR_IDTIERS;
          $scope.PR_NUMTIERS = $scope.recuperer.PR_NUMTIERS;
        ...
        $scope.objet_envoie = [
          {
            AG_CODEAGENCE: $rootScope.CODE_AGENCE,
            EN_CODEENTREPOT: $rootScope.CODE_ENTREPOT,
            PR_IDTIERS: $scope.PR_IDTIERS,
            PR_IDTIERSPRINCIPAL: "",
            NT_CODENATURETYPETIERS: "01",
            NT_CODENATURETIERS: $scope.FormAddTiTiers.natureTiers,
            VL_CODEVILLE: $scope.FormAddTiTiers.ville,
            PY_CODEPAYS: $scope.FormAddTiTiers.pays,
            PR_SIEGE: "", //$scope.FormAddTiTiers.siege,
            SX_CODESEXE: $scope.FormAddTiTiers.sexe,
            FM_CODEFORMEJURIDIQUE: "",
            AC_CODEACTIVITE: $scope.FormAddTiTiers.secteurDactivite,
            TP_CODETYPETIERS: $scope.FormAddTiTiers.typeDuTiers, //"006",//$scope.FormAddTiTiers.typeDuTiers,
            TC_CODECOMPTETYPETIERS: $scope.FormAddTiTiers.typeCompteAdd,
            PR_NUMTIERS: $scope.PR_NUMTIERS,
            PR_DATENAISSANCE: $scope.FormAddTiTiers.dateDeNaissance,
            PR_DENOMINATION: $scope.FormAddTiTiers.denomination,
            PR_DESCRIPTIONTIERS: "", //$scope.FormAddTiTiers.description,
            PR_ADRESSEPOSTALE: $scope.FormAddTiTiers.adressePostale,
            PR_ADRESSEGEOGRAPHIQUE: $scope.FormAddTiTiers.localisation,
            PR_TELEPHONE: $scope.FormAddTiTiers.telephone,
            PR_FAX: $scope.FormAddTiTiers.fax,
            PR_SITEWEB: $scope.FormAddTiTiers.siteWeb,
            PR_EMAIL: $scope.FormAddTiTiers.email,
            PR_GERANT: $scope.FormAddTiTiers.gerant,
            PR_STATUT: "N",
            PR_DATESAISIE: $rootScope.DATE_JOURNEE_DE_TRAVAIL,
            PR_ASDI: $scope.FormAddTiTiers.asdi,
            PR_TVA: $scope.FormAddTiTiers.tva,
            PR_STATUTDOUTEUX: "0",
            PR_PLAFONDCREDIT: $scope.FormAddTiTiers.plafondCredit,
            PR_NUMCPTECONTIBUABLE: "", //$scope.FormAddTiTiers.numCc,
            OP_CODEOPERATEUR: $rootScope.CODE_OPERATEUR,
            PR_DATEDEPART: "01-01-1900",
            PR_PHOTO: "", //$scope.tableauimage[0],
            /*$scope.base64 === undefined
                  ? $scope.recupererInfo.PR_PHOTO
                  : $scope.base64*/
            PR_SIGNATURE: "", //$scope.tableauimages[0],
            /*$scope.signbase64 === undefined
                  ? $scope.recupererInfo.PR_SIGNATURE
                  : $scope.signbase64*/ PL_NUMCOMPTE: "0",
            //$scope.FormAddTiTiers.numCompte,
            PR_TAUXREMISE: "0",
            CU_CODECASUTILISATION: $scope.FormAddTiTiers.casDutilisation,
            PR_NUMEROAGREMENT: $scope.FormAddTiTiers.numAgremant,
            PR_TAUXDECLARATION: "0",
            GP_CODEGROUPE: $scope.FormAddTiTiers.groupeDesTiers,
            PR_MANDATAIRE: "",
            PR_USAGER: "",
            IN_CODEINGREDIENT: "",
            PR_ESCOMPTE: $scope.FormAddTiTiers.autorisationDescompte,
            ZN_CODEZONE: "",
            ...
            /*AG_CODEAGENCE: $rootScope.CODE_AGENCE,
              ...
              TI_SIGNATURE:
                $scope.signbase64 === undefined
                  ...
                  : $scope.signbase64,
              PL_NUMCOMPTE: $scope.FormAddTiTiers.numCompte,
        ...
        $http
          .post("/LesTiers/AjoutDesProspect/", $scope.objet_envoie, {
            //headers: $scope.headers
          })
          .then(function (reponse) {
            ...
            if ($scope.tabEngTiers[0].clsObjetRetour.SL_RESULTAT === "TRUE") {
              ...
              if ($scope.etatForm == "2") {
                $scope.RetourSurListe = function () {
                  window.location.href = "#/gestion/liste/prospect";
                };
    ...
    $scope.resetPage = function () {
      ...
      $(document).ready(function () {
        ...
        // $("#idSiege").css("background-color", "#FFFFFF");
      ...
      $http
        ...
        .then(function (reponse) {
          ...
          if (
            ...
            $scope.afficheListeCasUtilisation();
          } else {
            $scope.$emit("UNLOAD");
            $rootScope.MessageDesListes(
    ...
    $scope.retourModifDesTiers = function () {
      ...
      $scope.afficheListeProspectPhoto($scope.recupererInfo.PR_IDTIERS);
      $scope.FormAddTiTiers.operateur = $scope.recupererInfo.OP_CODEOPERATEUR;
      $scope.FormAddTiTiers.numDuTiers = $scope.recupererInfo.PR_NUMTIERS;
      $scope.FormAddTiTiers.denomination = $scope.recupererInfo.PR_DENOMINATION;
      /* $scope.FormAddTiTiers.siege = $scope.recupererInfo.PR_SIEGE;
      $scope.FormAddTiTiers.description =
        $scope.recupererInfo.PR_DESCRIPTIONTIERS;*/
      ...
      $scope.FormAddTiTiers.dateDeNaissance =
        $scope.recupererInfo.PR_DATENAISSANCE;
      $scope.FormAddTiTiers.natureTiers =
        $scope.recupererInfo.NT_CODENATURETIERS;
      $scope.FormAddTiTiers.tva = $scope.recupererInfo.PR_TVA;
      $scope.FormAddTiTiers.asdi = $scope.recupererInfo.PR_ASDI;
      $scope.FormAddTiTiers.plafondCredit =
        $scope.recupererInfo.PR_PLAFONDCREDIT;
      $scope.FormAddTiTiers.typeCompteAdd =
        $scope.recupererInfo.TC_CODECOMPTETYPETIERS;
      ($scope.FormAddTiTiers.numCompte = 0), //$scope.recupererInfo.PL_NUMCOMPTE;
        // $scope.FormAddTiTiers.numCc = $scope.recupererInfo.PR_NUMCPTECONTIBUABLE;
        ($scope.FormAddTiTiers.gerant = $scope.recupererInfo.PR_GERANT);
      ...
      $scope.FormAddTiTiers.numAgremant =
        $scope.recupererInfo.PR_NUMEROAGREMENT;
      ...
      $scope.FormAddTiTiers.autorisationDescompte =
        $scope.recupererInfo.PR_ESCOMPTE;

      // $scope.FormAddTiTiers.img_avatar = $scope.recupererInfo.PR_PHOTO;
      // $scope.FormAddTiTiers.img_signature = $scope.recupererInfo.PR_SIGNATURE;

      $scope.FormAddTiTiers.telephone = $scope.recupererInfo.PR_TELEPHONE;
      $scope.FormAddTiTiers.siteWeb = $scope.recupererInfo.PR_SITEWEB;
      $scope.FormAddTiTiers.fax = $scope.recupererInfo.PR_FAX;
      $scope.FormAddTiTiers.email = $scope.recupererInfo.PR_EMAIL;
      $scope.FormAddTiTiers.adressePostale =
        $scope.recupererInfo.PR_ADRESSEPOSTALE;
      $scope.FormAddTiTiers.localisation =
        $scope.recupererInfo.PR_ADRESSEGEOGRAPHIQUE;
