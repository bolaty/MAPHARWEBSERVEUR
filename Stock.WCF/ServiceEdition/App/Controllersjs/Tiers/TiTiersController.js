  ...
  function ($scope, $http, $q, $location, $sce, $window, $rootScope) {
     ...
     /* if($scope.FormAddTiTiers.telWhatsApp == undefined || $scope.FormAddTiTiers.telWhatsApp == ""){
      ...
      if (statutphoto.length != 0 && $scope.pretACharger1 == false) {
        ...
        if (
          ...
          $scope.FormAddTiTiers.telWhatsApp === "" ||
          $scope.FormAddTiTiers.telWhatsApp === undefined ||
         ...
         /* $scope.FormAddTiTiers.plafondCredit === "" ||
          ...
          $scope.FormAddTiTiers.interlocuteur === "" ||
          $scope.FormAddTiTiers.interlocuteur === undefined 
        ) {
          $scope.$emit("UNLOAD");
          $(document).ready(function () {
            if (
            ...
            if (
              ...
              $("#idWhatsApp").css("background-color", "#FFE9E0");
            }
            if (
              $scope.FormAddTiTiers.denomination === "" ||
              $scope.FormAddTiTiers.denomination === undefined
          ...
          $scope.messageErreur = "La date de naissance n'est pas valide";
          $rootScope.MessageDerreurDesTypes($scope.messageErreur);
        } else if ($scope.FormAddTiTiers.plafondCredit != "" &&
          ...
          $rootScope.MessageDerreurDesTypes($scope.messageErreur);
        } else if ($scope.FormAddTiTiers.numAgremant != "" &&
          ...
          $scope.objet_envoie = [
            {
              ...
              TI_NOMINTERLOCUTEUR: $scope.FormAddTiTiers.interlocuteur,
    ...
    $scope.resetPage = function () {
      ...
      $(document).ready(function () {
        ...
        $("#idWhatsApp").css("background-color", "#FFFFFF");
    ...
    $scope.retourModifDesTiers = function () {
      ...
      $scope.FormAddTiTiers.interlocuteur = $scope.recupererInfo.TI_NOMINTERLOCUTEUR;
