...
namespace Stock.WCF
{
	...
	// REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom d'interface "IwsPlan_rerporting" à la fois dans le code et le fichier de configuration.
	[ServiceContract]
	public interface IwsPlan_rerporting
	{
        ...
        List<HT_Stock.BOJ.clsPlan_rerporting> pvgChargerDansDataSetPourCombo(List<HT_Stock.BOJ.clsPlan_rerporting> Objet);
