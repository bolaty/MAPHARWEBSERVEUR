...
namespace Stock.WCF
{
	...
	// REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom d'interface "IwsCtparautocategorie" à la fois dans le code et le fichier de configuration.
	[ServiceContract]
	public interface IwsCtparautocategorie
	{
        ...
        //// http://localhost:2723/Service/wsCtparautocategorie.svc/pvgAjouter
        ...
        List<HT_Stock.BOJ.clsCtparautocategorie> pvgAjouter(List<HT_Stock.BOJ.clsCtparautocategorie> Objet);
        ...
        ///<author>Home Technology</author>
        ///  PARAMETRES DE TEST POSTMAN
        //// http://localhost:2723/Service/wsCtparautocategorie.svc/pvgModifier
        ///  {"Objet" :[{"CodeAgence": "","CodeOperateur": "","CodeActivite": "","Libelle": "", "TYPEOPERATION": ""}]}
        [OperationContract]
        //[WebInvoke(Method = "GET", ResponseFormat = WebMessageFormat.Json, BodyStyle = WebMessageBodyStyle.Wrapped, UriTemplate = "pvgSelectListe/{PO_CODEActivite}/{TYPEOPERATION}")]
        ...
        List<HT_Stock.BOJ.clsCtparautocategorie> pvgModifier(List<HT_Stock.BOJ.clsCtparautocategorie> Objet);
        ...
        ///<author>Home Technology</author>
        ///  PARAMETRES DE TEST POSTMAN
        //// http://localhost:2723/Service/wsCtparautocategorie.svc/pvgSupprimer
        ///  {"Objet" :[{"CodeAgence": "","CodeOperateur": "","CodeActivite": "","Libelle": "", "TYPEOPERATION": ""}]}
        [OperationContract]
        //[WebInvoke(Method = "GET", ResponseFormat = WebMessageFormat.Json, BodyStyle = WebMessageBodyStyle.Wrapped, UriTemplate = "pvgSelectListe/{PO_CODEActivite}/{TYPEOPERATION}")]
        ...
        List<HT_Stock.BOJ.clsCtparautocategorie> pvgSupprimer(List<HT_Stock.BOJ.clsCtparautocategorie> Objet);
        ...
        ///<author>Home Technology</author>
        ///  PARAMETRES DE TEST POSTMAN
        //// http://localhost:2723/Service/wsCtparautocategorie.svc/pvgChargerDansDataSet
        ///  {"Objet" :[{"CodeAgence": "","CodeOperateur": "","CodeActivite": "","Libelle": "", "TYPEOPERATION": ""}]}
        [OperationContract]
        //[WebInvoke(Method = "GET", ResponseFormat = WebMessageFormat.Json, BodyStyle = WebMessageBodyStyle.Wrapped, UriTemplate = "pvgSelectListe/{PO_CODEActivite}/{TYPEOPERATION}")]
        ...
        List<HT_Stock.BOJ.clsCtparautocategorie> pvgChargerDansDataSet(List<HT_Stock.BOJ.clsCtparautocategorie> Objet);
        ...
        ///<author>Home Technology</author>
        ///  PARAMETRES DE TEST POSTMAN
        //// http://localhost:2723/Service/wsCtparautocategorie.svc/pvgChargerDansDataSetPourCombo
        ///  {"Objet" :[{"CodeAgence": "","CodeOperateur": "","CodeActivite": "","Libelle": "", "TYPEOPERATION": ""}]}
        [OperationContract]
        //[WebInvoke(Method = "GET", ResponseFormat = WebMessageFormat.Json, BodyStyle = WebMessageBodyStyle.Wrapped, UriTemplate = "pvgSelectListe/{PO_CODEActivite}/{TYPEOPERATION}")]
        ...
        List<HT_Stock.BOJ.clsCtparautocategorie> pvgChargerDansDataSetPourCombo(List<HT_Stock.BOJ.clsCtparautocategorie> Objet);
