...
namespace Stock.WCF
{
	...
	// REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom d'interface "IwsPays" à la fois dans le code et le fichier de configuration.
	[ServiceContract]
	public interface IwsPays
	{
        ...
        List<HT_Stock.BOJ.clsPays> pvgChargerDansDataSetPourCombo(List<HT_Stock.BOJ.clsPays> Objet);
