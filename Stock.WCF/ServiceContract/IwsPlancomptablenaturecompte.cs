...
namespace Stock.WCF
{
	...
	// REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom d'interface "IwsPlancomptablenaturecompte" à la fois dans le code et le fichier de configuration.
	[ServiceContract]
	public interface IwsPlancomptablenaturecompte
	{
        ...
        List<HT_Stock.BOJ.clsPlancomptablenaturecompte> pvgChargerDansDataSetPourCombo(List<HT_Stock.BOJ.clsPlancomptablenaturecompte> Objet);
