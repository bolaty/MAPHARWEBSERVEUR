...
namespace Stock.WCF
{
	...
	// REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom d'interface "IwsCtparreduction" à la fois dans le code et le fichier de configuration.
	[ServiceContract]
	public interface IwsCtparreduction
	{
        ...
        //// http://localhost:2723/Service/wsCtparreduction.svc/pvgChargerDansDataSet
        ...
        List<HT_Stock.BOJ.clsCtparreduction> pvgChargerDansDataSet(List<HT_Stock.BOJ.clsCtparreduction> Objet);
