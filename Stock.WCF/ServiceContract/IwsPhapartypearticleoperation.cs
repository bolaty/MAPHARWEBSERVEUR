...
namespace Stock.WCF
{
	...
	// REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom d'interface "IwsPhapartypearticleoperation" à la fois dans le code et le fichier de configuration.
	[ServiceContract]
	public interface IwsPhapartypearticleoperation
	{
        ...
        List<HT_Stock.BOJ.clsPhapartypearticleoperation> pvgChargerDansDataSetPourCombo(List<HT_Stock.BOJ.clsPhapartypearticleoperation> Objet);
