...
namespace Stock.WCF
{
	...
	// REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom d'interface "IwsNatureOperation" à la fois dans le code et le fichier de configuration.
	[ServiceContract]
	public interface IwsNatureOperation
    {
        ...
        //// http://localhost:2723/Service/wsNatureOperation.svc/pvgChargerDansDataSetPourCombo
        ...
        List<HT_Stock.BOJ.clsPhaparnatureoperation> pvgChargerDansDataSetPourCombo(List<HT_Stock.BOJ.clsPhaparnatureoperation> Objet);
