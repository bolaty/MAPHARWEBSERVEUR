...
namespace Stock.WCF
{
	...
	// REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom d'interface "IwsCtparintermediaire" à la fois dans le code et le fichier de configuration.
	[ServiceContract]
	public interface IwsCtparintermediaire
	{
        ...
        List<HT_Stock.BOJ.clsCtparintermediaire> pvgChargerDansDataSetPourCombo(List<HT_Stock.BOJ.clsCtparintermediaire> Objet);
