...
namespace Stock.WCF
{
	...
	// REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom d'interface "IwsComptapar_sens" à la fois dans le code et le fichier de configuration.
	[ServiceContract]
	public interface IwsComptapar_sens
	{
        ...
        List<HT_Stock.BOJ.clsComptapar_sens> pvgChargerDansDataSetPourCombo(List<HT_Stock.BOJ.clsComptapar_sens> Objet);
