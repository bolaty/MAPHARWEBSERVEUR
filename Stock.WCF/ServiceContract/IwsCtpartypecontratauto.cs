...
namespace Stock.WCF
{
	...
	// REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom d'interface "IwsCtpartypecontratauto" à la fois dans le code et le fichier de configuration.
	[ServiceContract]
	public interface IwsCtpartypecontratauto
	{
        ...
        List<HT_Stock.BOJ.clsCtpartypecontratauto> pvgChargerDansDataSetPourCombo(List<HT_Stock.BOJ.clsCtpartypecontratauto> Objet);
