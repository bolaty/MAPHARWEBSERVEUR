...
namespace Stock.WCF
{
	...
	public interface IwsPhafamilleoperation
	{
        ...
        [OperationContract]
        //[WebInvoke(Method = "GET", ResponseFormat = WebMessageFormat.Json, BodyStyle = WebMessageBodyStyle.Wrapped, UriTemplate = "pvgSelectListe/{PO_CODEPhafamilleoperation}/{TYPEOPERATION}")]
        [WebInvoke(Method = "POST", RequestFormat = WebMessageFormat.Json, UriTemplate = "pvgChargerDansDataSet1", ResponseFormat = WebMessageFormat.Json, BodyStyle = WebMessageBodyStyle.WrappedRequest)]
        List<HT_Stock.BOJ.clsPhafamilleoperation> pvgChargerDansDataSet1(List<HT_Stock.BOJ.clsPhafamilleoperation> Objet);
        ...
        ///<author>Home Technology</author>
        ///  PARAMETRES DE TEST POSTMAN
        //// http://localhost:2723/Service/wsPhafamilleoperation.svc/pvgChargerDansDataSetFamilleOperation
        ///  {"Objet" :[{"CodeAgence": "","CodeOperateur": "","CodePhafamilleoperation": "","Libelle": "", "TYPEOPERATION": ""}]}
        [OperationContract]
        //[WebInvoke(Method = "GET", ResponseFormat = WebMessageFormat.Json, BodyStyle = WebMessageBodyStyle.Wrapped, UriTemplate = "pvgSelectListe/{PO_CODEPhafamilleoperation}/{TYPEOPERATION}")]
        [WebInvoke(Method = "POST", RequestFormat = WebMessageFormat.Json, UriTemplate = "pvgChargerDansDataSetFamilleOperation", ResponseFormat = WebMessageFormat.Json, BodyStyle = WebMessageBodyStyle.WrappedRequest)]
        List<HT_Stock.BOJ.clsPhafamilleoperation> pvgChargerDansDataSetFamilleOperation(List<HT_Stock.BOJ.clsPhafamilleoperation> Objet);
