...
namespace Stock.WCF
{
	...
	// REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom d'interface "IwsPhaParTypeBudget" à la fois dans le code et le fichier de configuration.
	[ServiceContract]
	public interface IwsPhaParTypeBudget
    {
        ...
        //// http://localhost:2723/Service/wsPhaParTypeBudget.svc/pvgChargerDansDataSetPourCombo
