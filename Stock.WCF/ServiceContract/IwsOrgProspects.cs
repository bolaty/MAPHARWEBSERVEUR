...
namespace Stock.WCF
{
	...
	// REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom d'interface "IwsOrgProspects" à la fois dans le code et le fichier de configuration.
	[ServiceContract]
	public interface IwsOrgProspects
	{
        ...
        List<HT_Stock.BOJ.clsOrgProspects> pvgAjouter(List<HT_Stock.BOJ.clsOrgProspects> Objet);
        ...
        List<HT_Stock.BOJ.clsOrgProspects> pvgSupprimer(List<HT_Stock.BOJ.clsOrgProspects> Objet);
        ...
        List<HT_Stock.BOJ.clsOrgProspects> pvgChargerDansDataSetTiers(List<HT_Stock.BOJ.clsOrgProspects> Objet);
        ...
        [OperationContract]
        //[WebInvoke(Method = "GET", ResponseFormat = WebMessageFormat.Json, BodyStyle = WebMessageBodyStyle.Wrapped, UriTemplate = "pvgSelectListe/{PO_CODEActivite}/{TYPEOPERATION}")]
        [WebInvoke(Method = "POST", RequestFormat = WebMessageFormat.Json, UriTemplate = "pvgChargerPhotoPropect", ResponseFormat = WebMessageFormat.Json, BodyStyle = WebMessageBodyStyle.WrappedRequest)]
        List<HT_Stock.BOJ.clsOrgProspects> pvgChargerPhotoPropect(List<HT_Stock.BOJ.clsOrgProspects> Objet);
        ...
        List<HT_Stock.BOJ.clsOrgProspects> pvgChargerDansDataSetPourComboSelonNaturetypetiers(List<HT_Stock.BOJ.clsOrgProspects> Objet);
        ...
        List<HT_Stock.BOJ.clsOrgProspects> pvgChargerDansDataSetPourCombo(List<HT_Stock.BOJ.clsOrgProspects> Objet);
        ...
        List<HT_Stock.BOJ.clsOrgProspects> pvgSoldeGlobalReglement(List<HT_Stock.BOJ.clsOrgProspects> Objet);
        ...
        List<HT_Stock.BOJ.clsOrgProspects> pvgChargerRechercheTiersparNom(List<HT_Stock.BOJ.clsOrgProspects> Objet);
