...
namespace Stock.WCF
{
	...
	// REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom d'interface "IwsCtpartypeaffaire" à la fois dans le code et le fichier de configuration.
	[ServiceContract]
	public interface IwsCtpartypeaffaire
	{
        ...
        List<HT_Stock.BOJ.clsCtpartypeaffaire> pvgChargerDansDataSetPourCombo(List<HT_Stock.BOJ.clsCtpartypeaffaire> Objet);
