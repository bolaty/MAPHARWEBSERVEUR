...
namespace Stock.WCF
{
	...
	// REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom d'interface "IwsCtpargarantierisqueassuranceliaison" à la fois dans le code et le fichier de configuration.
	[ServiceContract]
	public interface IwsCtpargarantierisqueassuranceliaison
	{
        ...
        List<HT_Stock.BOJ.clsCtpargarantierisqueassuranceliaison> pvgChargerDansDataSet(List<HT_Stock.BOJ.clsCtpargarantierisqueassuranceliaison> Objet);
