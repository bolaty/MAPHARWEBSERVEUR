...
namespace Stock.WCF
{
	...
	public interface IwsOperateurdroit
	{
        ...
        ///<author>Home Technology</author>
        ///  PARAMETRES DE TEST POSTMAN
        //// http://localhost:2723/Service/wsOperateurdroit.svc/pvgChargerDansDataSetOperateurDroit
        ///  {"Objet" :[{"CodeAgence": "","CodeOperateur": "","CodeOperateurdroit": "","Libelle": "", "TYPEOPERATION": ""}]}
        [OperationContract]
        //[WebInvoke(Method = "GET", ResponseFormat = WebMessageFormat.Json, BodyStyle = WebMessageBodyStyle.Wrapped, UriTemplate = "pvgSelectListe/{PO_CODEOperateurdroit}/{TYPEOPERATION}")]
        ...
        List<HT_Stock.BOJ.clsOperateurdroit> pvgChargerDansDataSetOperateurDroit(List<HT_Stock.BOJ.clsOperateurdroit> Objet);
