...
namespace Stock.WCF
{
    ...
    public partial class wsPhapartypetiers : IwsPhapartypetiers
    {
        ...
        ///<returns>Une collection de clsInput valeur du résultat de la requete</returns>
        ///<author>Home Technology</author>
        public List<HT_Stock.BOJ.clsPhapartypetiers> pvgChargerDansDataSetPourCombo1(List<HT_Stock.BOJ.clsPhapartypetiers> Objet)
            {
        ...
        clsDonnee.vogUtilisateur = clsObjetEnvoi.OE_X;
            ...
            clsObjetEnvoi.OE_PARAM= new string[] { Objet[0].MG_CODEMODEGESTION, Objet[0].EC_CODECRAN };
        DataSet DataSet = new DataSet();
