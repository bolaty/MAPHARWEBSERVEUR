...
namespace Stock.WCF
{
    // REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom de classe "wsPlancomptableTemp" à la fois dans le code, le fichier svc et le fichier de configuration.
    // REMARQUE : pour lancer le client test WCF afin de tester ce service, sélectionnez wsPlancomptableTemp.svc ou wsPlancomptableTemp.svc.cs dans l'Explorateur de solutions et démarrez le débogage.
    public partial class wsPlancomptableTemp : IwsPlancomptableTemp
    {
        private clsDonnee _clsDonnee = new clsDonnee();
        private clsMessagesWSBLL clsMessagesWSBLL = new clsMessagesWSBLL();
        //private clsPlancomptableTempWSBLL clsPlancomptableTempWSBLL = new clsPlancomptableTempWSBLL();
        ...
        //    clsPlancomptableTemps = TestChampObligatoireListe(Objet[Idx]);
        //    //--VERIFICATION DU RESULTAT DU TEST
        //    if (clsPlancomptableTemps[0].clsObjetRetour.SL_RESULTAT == "FALSE") return clsPlancomptableTemps;
        //    //--TEST CONTRAINTE
        //    clsPlancomptableTemps = TestTestContrainteListe(Objet[Idx]);
        //    //--VERIFICATION DU RESULTAT DU TEST
        //    if (clsPlancomptableTemps[0].clsObjetRetour.SL_RESULTAT == "FALSE") return clsPlancomptableTemps;
        //}
        ...
        try
        {
                string[] vlpChamp1 = new string[] { "NO_CODENATUREOPERATION", "NO_LIBELLE" };
