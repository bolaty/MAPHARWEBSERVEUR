...
namespace Stock.WCF
{
    // REMARQUE : vous pouvez utiliser la commande Renommer du menu Refactoriser pour changer le nom de classe "wsPhaParTypeBudget" à la fois dans le code, le fichier svc et le fichier de configuration.
    // REMARQUE : pour lancer le client test WCF afin de tester ce service, sélectionnez wsPhaParTypeBudget.svc ou wsPhaParTypeBudget.svc.cs dans l'Explorateur de solutions et démarrez le débogage.
    public partial class wsPhaParTypeBudget : IwsPhaParTypeBudget
    {
