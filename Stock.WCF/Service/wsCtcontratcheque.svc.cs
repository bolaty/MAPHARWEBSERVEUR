        ...
        public List<HT_Stock.BOJ.clsCtcontratcheque> pvgAjouter(List<HT_Stock.BOJ.clsCtcontratcheque> Objet)
        {
            ...
            try
            {
                ...
                foreach (HT_Stock.BOJ.clsCtcontratcheque clsCtcontratchequeDTO in Objet)
                {
                    ...
                    if (clsCtcontratchequeDTO.AB_CODEAGENCEBANCAIREASSUREUR.ToString() != "")
                        clsCtcontratcheque.AB_CODEAGENCEBANCAIREASSUREUR = clsCtcontratchequeDTO.AB_CODEAGENCEBANCAIREASSUREUR.ToString();
                    else
                        clsCtcontratcheque.AB_CODEAGENCEBANCAIREASSUREUR = "1";
                   clsCtcontratcheque.CA_CODECONTRAT = clsCtcontratchequeDTO.CA_CODECONTRAT.ToString();
                    ...
                    clsCtcontratcheque.CH_DATEDEBUTCOUVERTURE = DateTime.Parse(clsCtcontratchequeDTO.CH_DATEDEBUTCOUVERTURE.ToString());
                    clsCtcontratcheque.CH_DATEFINCOUVERTURE = DateTime.Parse(clsCtcontratchequeDTO.CH_DATEFINCOUVERTURE.ToString());
        ...
        public List<HT_Stock.BOJ.clsCtcontratcheque> pvgSupprimer(List<HT_Stock.BOJ.clsCtcontratcheque> Objet)
        {
            ...
            if (DataSet.Tables[0].Rows.Count > 0)
            {
                foreach (DataRow row in DataSet.Tables[0].Rows)
                {
                    ...
                    clsCtcontratcheque.AB_CODEAGENCEBANCAIREASSUREUR = row["AB_CODEAGENCEBANCAIREASSUREUR"].ToString();
                    ...
                    clsCtcontratcheque.CH_REFCHEQUE = row["CH_REFCHEQUE"].ToString();
                        if (row["CH_VALEURCHEQUE"].ToString() != "")
                            clsCtcontratcheque.CH_VALEURCHEQUE = Double.Parse(row["CH_VALEURCHEQUE"].ToString()).ToString() ;// row["CH_VALEURCHEQUE"].ToString();
                    if (row["CH_PRIMEAENCAISSER"].ToString() != "")
                    clsCtcontratcheque.CH_PRIMEAENCAISSER =Double.Parse(row["CH_PRIMEAENCAISSER"].ToString()).ToString();// row["CH_PRIMEAENCAISSER"].ToString();
                        clsCtcontratcheque.CH_DATEANNULATIONCHEQUE = (row["CH_DATEANNULATIONCHEQUE"].ToString() != "") ? DateTime.Parse(row["CH_DATEANNULATIONCHEQUE"].ToString()).ToShortDateString(): "";
                    ...
                    clsCtcontratcheque.CH_DATEEMISSIONCHEQUE = (row["CH_DATEEMISSIONCHEQUE"].ToString() != "") ? DateTime.Parse(row["CH_DATEEMISSIONCHEQUE"].ToString()).ToShortDateString(): "";
                    ...
                    clsCtcontratcheque.CH_DATEVALIDATIONCHEQUE = (row["CH_DATEVALIDATIONCHEQUE"].ToString() != "") ? DateTime.Parse(row["CH_DATEVALIDATIONCHEQUE"].ToString()).ToShortDateString() : "";
                    clsCtcontratcheque.CH_DATEVALIDATIONCHEQUE = (clsCtcontratcheque.CH_DATEVALIDATIONCHEQUE != "01/01/1900") ? clsCtcontratcheque.CH_DATEVALIDATIONCHEQUE : "";
                        if (clsCtcontratcheque.CH_DATEVALIDATIONCHEQUE == "")
                            clsCtcontratcheque.CH_DATEVALIDATIONCHEQUE = "01/01/1900";


                    clsCtcontratcheque.CH_NOMTIREUR = row["CH_NOMTIREUR"].ToString();
                    clsCtcontratcheque.CH_NOMTIRE = row["CH_NOMTIRE"].ToString();
                    clsCtcontratcheque.CH_DATERECEPTIONCHEQUE = (row["CH_DATERECEPTIONCHEQUE"].ToString() != "") ? DateTime.Parse(row["CH_DATERECEPTIONCHEQUE"].ToString()).ToShortDateString(): "";
                    ...
                    clsCtcontratcheque.CH_DATEEFFET = (row["CH_DATEEFFET"].ToString() != "") ? DateTime.Parse(row["CH_DATEEFFET"].ToString()).ToShortDateString(): "";
                    clsCtcontratcheque.CH_DATEEFFET = (clsCtcontratcheque.CH_DATEEFFET != "01/01/1900") ? clsCtcontratcheque.CH_DATEEFFET : "";


                    clsCtcontratcheque.CH_DATEDEBUTCOUVERTURE = (row["CH_DATEDEBUTCOUVERTURE"].ToString() != "") ? DateTime.Parse(row["CH_DATEDEBUTCOUVERTURE"].ToString()).ToShortDateString(): "";
                    clsCtcontratcheque.CH_DATEDEBUTCOUVERTURE = (clsCtcontratcheque.CH_DATEDEBUTCOUVERTURE != "01/01/1900") ? clsCtcontratcheque.CH_DATEDEBUTCOUVERTURE : "";

                    clsCtcontratcheque.CH_DATEFINCOUVERTURE = (row["CH_DATEFINCOUVERTURE"].ToString() != "") ? DateTime.Parse(row["CH_DATEFINCOUVERTURE"].ToString()).ToShortDateString(): "";
                    clsCtcontratcheque.CH_DATEFINCOUVERTURE = (clsCtcontratcheque.CH_DATEFINCOUVERTURE != "01/01/1900") ? clsCtcontratcheque.CH_DATEFINCOUVERTURE : "";
                    ...
                    clsCtcontratcheque.AB_LIBELLEASSUEUR = row["AB_LIBELLEASSUEUR"].ToString();
                    clsCtcontratcheque.BQ_CODEBANQUEASSUREUR = row["BQ_CODEBANQUEASSUREUR"].ToString();
                    clsCtcontratcheque.BQ_RAISONSOCIALASSUREUR = row["BQ_RAISONSOCIALASSUREUR"].ToString();
                    clsCtcontratcheque.BQ_SIGLEASSUREUR = row["BQ_SIGLEASSUREUR"].ToString();



                        //clsCtcontratcheque.CH_LIBELLEPHOTOCHEQUE = row["CH_LIBELLEPHOTOCHEQUE"].ToString();
                        clsCtcontratcheque.TI_NUMTIERS = row["TI_NUMTIERS"].ToString();
                    clsCtcontratcheque.RQ_CODERISQUE = row["RQ_CODERISQUE"].ToString();
                    ...
                    clsCtcontratcheque.CA_NUMPOLICE = row["CA_NUMPOLICE"].ToString();
                        ...
                        clsCtcontratcheque.CA_DATEEFFET = (row["CA_DATEEFFET"].ToString() != "") ? DateTime.Parse(row["CA_DATEEFFET"].ToString()).ToShortDateString(): "";
                        clsCtcontratcheque.CA_DATEEFFET = (clsCtcontratcheque.CA_DATEEFFET != "01/01/1900") ? clsCtcontratcheque.CA_DATEEFFET : "";

                        clsCtcontratcheque.CA_DATEECHEANCE = (row["CA_DATEECHEANCE"].ToString() != "") ? DateTime.Parse(row["CA_DATEECHEANCE"].ToString()).ToShortDateString(): "";
                        clsCtcontratcheque.CA_DATEECHEANCE = (clsCtcontratcheque.CA_DATEECHEANCE != "01/01/1900") ? clsCtcontratcheque.CA_DATEECHEANCE : "";
