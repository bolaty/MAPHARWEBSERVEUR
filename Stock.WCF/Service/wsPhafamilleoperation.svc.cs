    ...
    public partial class wsPhafamilleoperation : IwsPhafamilleoperation
    {
        ...
        public List<HT_Stock.BOJ.clsPhafamilleoperation> pvgAjouter(List<HT_Stock.BOJ.clsPhafamilleoperation> Objet)
        {
            ...
            try
            {
                ...
                foreach (HT_Stock.BOJ.clsPhafamilleoperation clsPhafamilleoperationDTO in Objet)
                {
                    ...
                    if(clsPhafamilleoperationDTO.FO_NUMEROORDRE.ToString()!="")
                        clsPhafamilleoperation.FO_NUMEROORDRE =int.Parse(clsPhafamilleoperationDTO.FO_NUMEROORDRE.ToString());
                    else
                        clsPhafamilleoperation.FO_NUMEROORDRE =0;
                    
                    clsPhafamilleoperation.NF_CODENATUREFAMILLEOPERATION = clsPhafamilleoperationDTO.NF_CODENATUREFAMILLEOPERATION.ToString();
                    clsPhafamilleoperation.FO_STATUT = "O";
        ...
        public List<HT_Stock.BOJ.clsPhafamilleoperation> pvgSupprimer(List<HT_Stock.BOJ.clsPhafamilleoperation> Objet)
        {
            ...
            catch (SqlException SQLEx)
            {
                ...
                clsPhafamilleoperation.clsObjetRetour = new Common.clsObjetRetour();
                clsPhafamilleoperation.clsObjetRetour.SL_CODEMESSAGE = "99";
                clsPhafamilleoperation.clsObjetRetour.SL_MESSAGE = vlpMessage;
                clsPhafamilleoperation.clsObjetRetour.SL_RESULTAT = "FALSE";
                //Execution du log
            ...
            ///<returns>Une collection de clsInput valeur du résultat de la requete</returns>
            ///<author>Home Technology</author>
            public List<HT_Stock.BOJ.clsPhafamilleoperation> pvgChargerDansDataSet1(List<HT_Stock.BOJ.clsPhafamilleoperation> Objet)
            {
            ...
            {
            clsDonnee.pvgConnectionBase();
            DataSet = clsPhafamilleoperationWSBLL.pvgChargerDansDataSet1(clsDonnee, clsObjetEnvoi);
            clsPhafamilleoperations = new List<HT_Stock.BOJ.clsPhafamilleoperation>();
            if (DataSet.Tables[0].Rows.Count > 0)
            {
                foreach (DataRow row in DataSet.Tables[0].Rows)
                {
                    ...
                    clsPhafamilleoperation.FO_CODEFAMILLEOPERATION = row["FO_CODEFAMILLEOPERATION"].ToString();
                    clsPhafamilleoperation.FO_LIBELLEFAMILLEOPERATION = row["FO_LIBELLEFAMILLEOPERATION"].ToString();
                    clsPhafamilleoperation.NF_CODENATUREFAMILLEOPERATION = row["NF_CODENATUREFAMILLEOPERATION"].ToString();
                    clsPhafamilleoperation.FO_NUMEROORDRE = row["FO_NUMEROORDRE"].ToString();
                    Stock.BOJ.clsPhanaturefamilleoperation clsPhanaturefamilleoperation = new Stock.BOJ.clsPhanaturefamilleoperation();
                    clsPhanaturefamilleoperationWSBLL clsPhanaturefamilleoperationWSBLL = new clsPhanaturefamilleoperationWSBLL();
                    Stock.BOJ.clsObjetEnvoi clsObjetEnvoi1 = new Stock.BOJ.clsObjetEnvoi();
                    clsObjetEnvoi1.OE_PARAM = new string[] { clsPhafamilleoperation.NF_CODENATUREFAMILLEOPERATION };

                    clsPhanaturefamilleoperation = clsPhanaturefamilleoperationWSBLL.pvgTableLibelle(clsDonnee, clsObjetEnvoi1);
                    if(clsPhanaturefamilleoperation!=null)
                    clsPhafamilleoperation.NF_LIBELLENATUREFAMILLEOPERATION = clsPhanaturefamilleoperation.NF_LIBELLENATUREFAMILLEOPERATION1.ToString();
                    clsPhafamilleoperation.clsObjetRetour = new Common.clsObjetRetour();
                    clsPhafamilleoperation.clsObjetRetour.SL_CODEMESSAGE ="00";
                    clsPhafamilleoperation.clsObjetRetour.SL_RESULTAT = "TRUE";
                    clsPhafamilleoperation.clsObjetRetour.SL_MESSAGE ="Opération réalisée avec succès !!!";
        ...
        ///<returns>Une collection de clsInput valeur du résultat de la requete</returns>
        ///<author>Home Technology</author>
        public List<HT_Stock.BOJ.clsPhafamilleoperation> pvgChargerDansDataSetFamilleOperation(List<HT_Stock.BOJ.clsPhafamilleoperation> Objet)
        {
        ...
        {
        clsDonnee.pvgConnectionBase();
        DataSet = clsPhafamilleoperationWSBLL.pvgChargerDansDataSetFamilleOperation(clsDonnee, clsObjetEnvoi);
        clsPhafamilleoperations = new List<HT_Stock.BOJ.clsPhafamilleoperation>();
        if (DataSet.Tables[0].Rows.Count > 0)
        {
            foreach (DataRow row in DataSet.Tables[0].Rows)
